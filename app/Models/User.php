...
class User extends Authenticatable
{
    ...
    public function clubs(): BelongsToMany
    {
        return $this->belongsToMany(Club::class)
            ->withPivot(['role', 'rank', 'home_club_name', 'home_club_number', 'member_number', 'status', 'phone', 'emergency_contact', 'dietary_notes', 'invitation_token', 'invited_at', 'invitation_accepted_at'])
            ->withTimestamps();
    }
