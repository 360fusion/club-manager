...
const parseUrlState = () => {
  ...
  const basePath = `/${props.club.slug}/admin/accounting`;
...
const getTypeBadge = (type) => {
  switch (type) {
    case 'asset': return 'bg-emerald-50 dark:bg-emerald-950/40 text-emerald-700 dark:text-emerald-300 border-emerald-200 dark:border-emerald-800/60';
    case 'liability': return 'bg-amber-50 dark:bg-amber-950/40 text-amber-700 dark:text-amber-300 border-amber-200 dark:border-amber-800/60';
    case 'equity': return 'bg-blue-50 dark:bg-blue-950/40 text-blue-700 dark:text-blue-300 border-blue-200 dark:border-blue-800/60';
    case 'revenue': return 'bg-blue-50 dark:bg-blue-950/40 text-blue-700 dark:text-blue-300 border-blue-200 dark:border-blue-800/60';
    case 'expense': return 'bg-rose-50 dark:bg-rose-950/40 text-rose-700 dark:text-rose-300 border-rose-200 dark:border-rose-800/60';
    default: return 'bg-slate-50 dark:bg-slate-800/50 text-slate-700 dark:text-slate-200 border-slate-200 dark:border-slate-800';
  }
};
</script>
...
<template>
  <AdminLayout :club="club" title="Accounting" active-tab="accounting">
    ...
    <div class="space-y-6">
      ...
      <div class="bg-slate-900 dark:bg-slate-700 border border-slate-800 rounded-2xl shadow-sm p-1.5 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-2 relative z-30">
        <nav class="flex items-center px-1 text-xs sm:text-sm font-semibold text-slate-300 overflow-visible flex-wrap gap-1">
          <button
            ...
            :class="[
              ...
              activeTab === 'home' ? 'font-extrabold text-white bg-blue-600 shadow-sm' : 'text-slate-400 hover:text-white hover:bg-slate-800/80 dark:hover:bg-slate-600'
            ]"
          >
            <span>Home</span>
          </button>
          ...
          <button
            ...
            :class="[
              'px-4 py-2.5 relative transition-all cursor-pointer flex items-center gap-2 whitespace-nowrap rounded-xl',
              activeTab === 'sales' ? 'font-extrabold text-white bg-blue-600 shadow-sm' : 'text-slate-400 hover:text-white hover:bg-slate-800/80 dark:hover:bg-slate-600'
            ]"
          >
            <span>Sales</span>
          </button>
          ...
          <button
            ...
            :class="[
              'px-4 py-2.5 relative transition-all cursor-pointer flex items-center gap-2 whitespace-nowrap rounded-xl',
              activeTab === 'purchases' ? 'font-extrabold text-white bg-blue-600 shadow-sm' : 'text-slate-400 hover:text-white hover:bg-slate-800/80 dark:hover:bg-slate-600'
            ]"
          >
            <span>Purchases</span>
          </button>
          ...
          <button
            ...
            :class="[
              'px-4 py-2.5 relative transition-all cursor-pointer flex items-center gap-2 whitespace-nowrap rounded-xl',
              activeTab === 'reporting' ? 'font-extrabold text-white bg-blue-600 shadow-sm' : 'text-slate-400 hover:text-white hover:bg-slate-800/80 dark:hover:bg-slate-600'
            ]"
          >
            <span>Reporting</span>
          </button>
          ...
          <div class="relative accounting-dropdown-container">
            <button
              ...
              :class="[
                ...
                ['accounting', 'bank-accounts', 'chart-of-accounts'].includes(activeTab) ? 'font-extrabold text-white bg-blue-600 shadow-sm' : 'text-slate-400 hover:text-white hover:bg-slate-800/80 dark:hover:bg-slate-600'
              ]"
            >
            ...
            <div
              ...
              class="absolute left-0 top-full mt-2 w-56 bg-slate-900 dark:bg-slate-700 border border-slate-700 rounded-xl shadow-2xl py-1.5 z-50 text-xs font-semibold text-slate-200 animate-in fade-in zoom-in-95 duration-100"
            >
              <button
                type="button"
              ...
              <button
                type="button"
                @click="showAccountingDropdown = false; navigateTo('accounting')"
                class="w-full text-left px-4 py-2.5 hover:bg-slate-800 dark:hover:bg-slate-600 hover:text-white flex items-center gap-2 border-t border-slate-800 mt-1 pt-2 cursor-pointer transition-colors"
              >
                <span>📖</span>
          ...
          <button
            ...
            :class="[
              'px-4 py-2.5 relative transition-all cursor-pointer flex items-center gap-2 whitespace-nowrap rounded-xl',
              activeTab === 'contacts' ? 'font-extrabold text-white bg-blue-600 shadow-sm' : 'text-slate-400 hover:text-white hover:bg-slate-800/80 dark:hover:bg-slate-600'
            ]"
          >
            <span>Contacts</span>
          </button>
          ...
          <button
            ...
            :class="[
              'px-4 py-2.5 relative transition-all cursor-pointer flex items-center gap-2 whitespace-nowrap rounded-xl',
              activeTab === 'reconciliation' ? 'font-extrabold text-white bg-blue-600 shadow-sm' : 'text-slate-400 hover:text-white hover:bg-slate-800/80 dark:hover:bg-slate-600'
            ]"
          >
        ...
        <div class="flex items-center gap-2 px-2 py-1 shrink-0">
          ...
          <div class="relative add-menu-container">
            ...
            <div
              v-if="showAddMenu"
              class="absolute right-0 mt-2 w-48 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl shadow-xl py-1.5 z-50 text-xs font-semibold text-slate-700 dark:text-slate-200"
            >
              <Link
                :href="route('admin.accounting.invoices.create', club.slug)"
                @click="showAddMenu = false"
                class="flex items-center gap-2.5 px-4 py-2 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors text-slate-700 dark:text-slate-200 hover:text-slate-900 dark:hover:text-white"
              >
                <span>🧾</span>
          ...
          <Link
            ...
            class="px-3 py-2 text-slate-400 hover:text-white hover:bg-slate-800/80 dark:hover:bg-slate-600 font-semibold text-xs sm:text-sm rounded-xl transition-all cursor-pointer flex items-center gap-1.5 whitespace-nowrap"
          >
      ...
      <div v-if="activeTab === 'home'" class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
        ...
        <div class="bg-white dark:bg-slate-900 p-4 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-1">
          ...
          <span class="text-lg font-black text-emerald-700 dark:text-emerald-300 block">{{ formatCurrency(summary.total_assets) }}</span>
          <span class="text-[10px] text-slate-500 dark:text-slate-400 block font-medium">Bank & Receivables</span>
        </div>

        <!-- 2. Total Liabilities -->
        <div class="bg-white dark:bg-slate-900 p-4 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-1">
          <span class="text-[10px] font-extrabold text-slate-400 uppercase tracking-wider block">Liabilities</span>
          <span class="text-lg font-black text-amber-700 dark:text-amber-300 block">{{ formatCurrency(summary.total_liabilities) }}</span>
          <span class="text-[10px] text-slate-500 dark:text-slate-400 block font-medium">Payables & Prepayments</span>
        </div>

        <!-- 3. Total Equity -->
        <div class="bg-white dark:bg-slate-900 p-4 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-1">
          <span class="text-[10px] font-extrabold text-slate-400 uppercase tracking-wider block">Club Equity</span>
          <span class="text-lg font-black text-blue-700 dark:text-blue-300 block">{{ formatCurrency(summary.total_equity) }}</span>
          <span class="text-[10px] text-slate-500 dark:text-slate-400 block font-medium">Retained Reserves</span>
        </div>

        <!-- 4. Total Revenue -->
        <div class="bg-white dark:bg-slate-900 p-4 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-1">
          <span class="text-[10px] font-extrabold text-slate-400 uppercase tracking-wider block">Total Income</span>
          <span class="text-lg font-black text-blue-700 dark:text-blue-300 block">{{ formatCurrency(summary.total_revenue) }}</span>
          <span class="text-[10px] text-slate-500 dark:text-slate-400 block font-medium">Dues & Tickets</span>
        </div>

        <!-- 5. Total Expenses -->
        <div class="bg-white dark:bg-slate-900 p-4 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-1">
          <span class="text-[10px] font-extrabold text-slate-400 uppercase tracking-wider block">Total Expenses</span>
          <span class="text-lg font-black text-rose-700 dark:text-rose-300 block">{{ formatCurrency(summary.total_expenses) }}</span>
          <span class="text-[10px] text-slate-500 dark:text-slate-400 block font-medium">Operational Costs</span>
        </div>

        <!-- 6. Net Surplus / Profit -->
        <div class="bg-slate-900 dark:bg-slate-700 text-white p-4 rounded-2xl border border-slate-800 shadow-md space-y-1">
      ...
      <div v-if="activeTab === 'home'" class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white dark:bg-slate-900 p-6 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-4">
          <div class="flex items-center justify-between pb-3 border-b border-slate-100 dark:border-slate-800">
            <h3 class="text-base font-extrabold text-slate-900 dark:text-white">Balance Sheet Summary</h3>
            <span class="text-xs font-semibold text-slate-400">As of today</span>
          </div>

          <div class="space-y-3 text-xs">
            <div class="flex items-center justify-between p-3 bg-emerald-50/50 dark:bg-emerald-950/50 rounded-xl border border-emerald-100 dark:border-emerald-900/40">
              <span class="font-bold text-slate-800 dark:text-slate-100">Total Assets</span>
              <span class="font-black text-emerald-700 dark:text-emerald-300 text-sm">{{ formatCurrency(summary.total_assets) }}</span>
            </div>

            <div class="flex items-center justify-between p-3 bg-amber-50/50 dark:bg-amber-950/50 rounded-xl border border-amber-100 dark:border-amber-900/40">
              <span class="font-bold text-slate-800 dark:text-slate-100">Total Liabilities</span>
              <span class="font-black text-amber-700 dark:text-amber-300 text-sm">{{ formatCurrency(summary.total_liabilities) }}</span>
            </div>

            <div class="flex items-center justify-between p-3 bg-blue-50/50 dark:bg-blue-950/50 rounded-xl border border-blue-100 dark:border-blue-900/40">
              <span class="font-bold text-slate-800 dark:text-slate-100">Total Club Equity</span>
              <span class="font-black text-blue-700 dark:text-blue-300 text-sm">{{ formatCurrency(summary.total_equity) }}</span>
            </div>

            <div class="p-3.5 bg-slate-900 dark:bg-slate-700 text-white rounded-2xl flex items-center justify-between mt-4">
              <div>
        ...
        <div class="bg-white dark:bg-slate-900 p-6 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-4">
          <div class="flex items-center justify-between pb-3 border-b border-slate-100 dark:border-slate-800">
            <h3 class="text-base font-extrabold text-slate-900 dark:text-white">Income Statement (P&L)</h3>
            <span class="text-xs font-semibold text-slate-400">Year to Date</span>
          </div>

          <div class="space-y-3 text-xs">
            <div class="flex items-center justify-between p-3 bg-blue-50/50 dark:bg-blue-950/50 rounded-xl border border-blue-100 dark:border-blue-900/40">
              <span class="font-bold text-slate-800 dark:text-slate-100">Operating Income / Dues</span>
              <span class="font-black text-blue-700 dark:text-blue-300 text-sm">{{ formatCurrency(summary.total_revenue) }}</span>
            </div>

            <div class="flex items-center justify-between p-3 bg-rose-50/50 dark:bg-rose-950/50 rounded-xl border border-rose-100 dark:border-rose-900/40">
              <span class="font-bold text-slate-800 dark:text-slate-100">Operating Expenses</span>
              <span class="font-black text-rose-700 dark:text-rose-300 text-sm">{{ formatCurrency(summary.total_expenses) }}</span>
            </div>

            <div class="p-4 bg-slate-50 dark:bg-slate-800/50 rounded-2xl border border-slate-200 dark:border-slate-800 flex items-center justify-between mt-4">
              <div>
                <span class="font-extrabold text-slate-900 dark:text-white block text-xs">Net Operating Surplus</span>
                <span class="text-[10px] text-slate-500 dark:text-slate-400 block">Revenue minus Expenses</span>
              </div>
              <span class="text-base font-black" :class="summary.net_income >= 0 ? 'text-emerald-600 dark:text-emerald-400' : 'text-rose-600 dark:text-rose-400'">
                {{ formatCurrency(summary.net_income) }}
              </span>
            </div>
          </div>
      ...
      <div v-if="activeTab === 'home'" class="bg-white dark:bg-slate-900 p-6 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-4">
        <div class="flex flex-col sm:flex-row sm:items-center justify-between pb-3 border-b border-slate-100 dark:border-slate-800 gap-3">
          <div class="flex items-center gap-3">
            <div class="w-10 h-10 rounded-2xl bg-blue-50 dark:bg-blue-950/40 text-blue-600 dark:text-blue-400 flex items-center justify-center font-bold text-lg border border-blue-100 dark:border-blue-900/40 shadow-sm">
              🏛️
            </div>
            <div>
              <h3 class="text-base font-extrabold text-slate-900 dark:text-white">Donations & Gift Aid Tax Recovery Summary</h3>
              <p class="text-xs text-slate-500 dark:text-slate-400 font-medium">HMRC 25% Tax Relief & Relief Chest Bank Reconciliation Overview</p>
            </div>
          </div>
          <button
            @click="activeTab = 'reconciliation'"
            class="inline-flex items-center gap-1.5 px-4 py-2 text-xs font-bold text-blue-700 dark:text-blue-300 bg-blue-50 dark:bg-blue-950/40 hover:bg-blue-100 dark:hover:bg-blue-900/40 rounded-xl border border-blue-200/60 dark:border-blue-800/60 transition shadow-xs self-start sm:self-auto cursor-pointer"
          >
      ...
      <div v-if="activeTab === 'sales'" class="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden space-y-4 p-6">

        <!-- Header row -->
        <div class="flex items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-4">
          <div>
            <h3 class="text-lg font-black text-slate-900 dark:text-white">Sales Invoicing & Receivables</h3>
        ...
        <div class="flex flex-wrap items-center gap-2">
          ...
          <div class="relative flex-1 min-w-[200px]">
            ...
            <input
              ...
              class="w-full pl-7 pr-3 py-2 border border-slate-200 dark:border-slate-800 rounded-xl text-xs font-medium text-slate-900 dark:text-white bg-slate-50 dark:bg-slate-800/50 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-blue-400"
            />
          </div>
          ...
          <select
            ...
            class="px-3 py-2 border border-slate-200 dark:border-slate-800 rounded-xl text-xs font-bold text-slate-700 dark:text-slate-200 bg-slate-50 dark:bg-slate-800/50 focus:outline-none focus:ring-2 focus:ring-blue-400 cursor-pointer"
          >
          ...
          <div class="flex items-center gap-1 flex-wrap">
            <button
              ...
              :class="['px-2.5 py-1.5 rounded-lg text-[11px] font-extrabold transition-all cursor-pointer', salesFyFilter === 'all' && salesYearFilter === 'all' ? 'bg-slate-800 text-white' : 'bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700']"
            >All</button>
            <button
              ...
              :class="['px-2.5 py-1.5 rounded-lg text-[11px] font-extrabold transition-all cursor-pointer', salesFyFilter === fy ? 'bg-blue-600 text-white' : 'bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700']"
            >FY {{ fy }}</button>
          </div>
        ...
        <!-- Empty state -->
        <div v-if="!filteredInvoices.length" class="text-center py-12 border-2 border-dashed border-slate-200 dark:border-slate-800 rounded-2xl bg-slate-50 dark:bg-slate-800/50">
          <span class="text-3xl block mb-2">🧾</span>
          <span class="text-xs font-bold text-slate-700 dark:text-slate-200 block">{{ (invoices || []).length ? 'No results match your filters' : 'No Invoices Found' }}</span>
        ...
        <div v-else class="overflow-x-auto border border-slate-200 dark:border-slate-800 rounded-2xl">
          <table class="w-full text-left border-collapse">
            <thead>
              <tr class="bg-slate-50 dark:bg-slate-800/50 border-b border-slate-200/80 dark:border-slate-800/80 text-[11px] font-extrabold text-slate-500 dark:text-slate-400 uppercase tracking-wider">
              ...
              <tr v-for="inv in filteredInvoices" :key="inv.id" class="hover:bg-slate-50/80 dark:hover:bg-slate-800/50/80 transition-colors">
                <td class="py-3 px-4">
                  <button
                    ...
                    class="font-mono font-bold text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-200 hover:underline cursor-pointer"
                  >
                    {{ inv.invoice_number }}
                  </button>
                </td>
                <td class="py-3 px-4 font-bold text-slate-900 dark:text-white">{{ inv.recipient_name }}</td>
                <td class="py-3 px-4 text-slate-600 dark:text-slate-300">
                  <div class="flex items-center gap-2">
                    <button
                      type="button"
                      @click="openEditInvoiceModal(inv)"
                      class="font-bold text-slate-900 dark:text-white hover:text-blue-600 dark:hover:text-blue-400 hover:underline text-left cursor-pointer"
                    >
                      {{ inv.title }}
                    </button>
                    <button
                      ...
                      class="inline-flex items-center gap-1 px-2 py-0.5 bg-blue-50 dark:bg-blue-950/40 hover:bg-blue-100 dark:hover:bg-blue-900/40 text-blue-700 dark:text-blue-300 text-[10px] font-extrabold rounded-md border border-blue-200 dark:border-blue-800/60 transition-colors cursor-pointer"
                    >
                      📎 View Document
                    </button>
                  </div>
                ...
                <td class="py-3 px-4 text-center">
                  <div class="flex items-center justify-center gap-1.5">
                    <button
                      ...
                      class="px-2.5 py-1 bg-blue-600 hover:bg-blue-700 text-white border border-blue-700 text-[10px] font-extrabold rounded-lg transition-all cursor-pointer flex items-center gap-1 shadow-sm"
                    >
                      🚀 Issue
                    </button>
                    <button
      ...
      <div v-if="activeTab === 'purchases'" class="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden space-y-4 p-6">

        <!-- Header row -->
        <div class="flex items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-4">
          <div>
            <h3 class="text-lg font-black text-slate-900 dark:text-white">Purchases & Vendor Bills</h3>
        ...
        <div class="flex flex-wrap items-center gap-2">
          ...
          <div class="relative flex-1 min-w-[200px]">
            ...
            <input
              ...
              class="w-full pl-7 pr-3 py-2 border border-slate-200 dark:border-slate-800 rounded-xl text-xs font-medium text-slate-900 dark:text-white bg-slate-50 dark:bg-slate-800/50 focus:outline-none focus:ring-2 focus:ring-amber-400 focus:border-amber-400"
            />
          </div>
          ...
          <select
            ...
            class="px-3 py-2 border border-slate-200 dark:border-slate-800 rounded-xl text-xs font-bold text-slate-700 dark:text-slate-200 bg-slate-50 dark:bg-slate-800/50 focus:outline-none focus:ring-2 focus:ring-amber-400 cursor-pointer"
          >
            <option value="all">All Years</option>
          ...
          <div class="flex items-center gap-1 flex-wrap">
            <button
              ...
              :class="['px-2.5 py-1.5 rounded-lg text-[11px] font-extrabold transition-all cursor-pointer', billsFyFilter === 'all' && billsYearFilter === 'all' ? 'bg-slate-800 text-white' : 'bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700']"
            >All</button>
            <button
              ...
              :class="['px-2.5 py-1.5 rounded-lg text-[11px] font-extrabold transition-all cursor-pointer', billsFyFilter === fy ? 'bg-amber-600 text-white' : 'bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700']"
            >FY {{ fy }}</button>
          </div>
        ...
        <!-- Empty state -->
        <div v-if="!filteredBills.length" class="text-center py-12 border-2 border-dashed border-slate-200 dark:border-slate-800 rounded-2xl bg-slate-50 dark:bg-slate-800/50">
          <span class="text-3xl block mb-2">📄</span>
          <span class="text-xs font-bold text-slate-700 dark:text-slate-200 block">{{ (bills || []).length ? 'No results match your filters' : 'No Vendor Bills Recorded' }}</span>
              ...
              <tr v-for="b in filteredBills" :key="b.id" class="hover:bg-slate-50/80 dark:hover:bg-slate-800/50/80 transition-colors">
                <td class="py-3 px-4">
                  <button
                    ...
                    class="font-mono font-bold text-amber-700 dark:text-amber-300 hover:text-amber-900 dark:hover:text-amber-200 hover:underline cursor-pointer"
                  >
                    {{ b.bill_number }}
                  </button>
                </td>
                <td class="py-3 px-4 font-bold text-slate-900 dark:text-white">
                  <button
                    type="button"
                    @click="openEditBillModal(b)"
                    class="font-bold text-slate-900 dark:text-white hover:text-amber-700 dark:hover:text-amber-300 hover:underline text-left cursor-pointer"
                  >
                    {{ b.vendor_name }}
                  </button>
                </td>
                <td class="py-3 px-4 text-slate-600 dark:text-slate-300">
                  <div class="flex items-center gap-2">
                    ...
                    <button
                      ...
                      class="inline-flex items-center gap-1 px-2 py-0.5 bg-amber-50 dark:bg-amber-950/40 hover:bg-amber-100 dark:hover:bg-amber-900/40 text-amber-800 dark:text-amber-200 text-[10px] font-extrabold rounded-md border border-amber-200 dark:border-amber-800/60 transition-colors cursor-pointer"
                    >
                      📎 View Receipt
                    </button>
                  </div>
      ...
      <div v-if="activeTab === 'reporting'" class="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm p-6 space-y-6">
        <div class="border-b border-slate-100 dark:border-slate-800 pb-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
        ...
        <div class="bg-slate-50 dark:bg-slate-800/50 p-4 rounded-2xl border border-slate-200/80 dark:border-slate-800/80 shadow-xs flex flex-col lg:flex-row lg:items-center justify-between gap-4">
          <div class="flex flex-wrap items-center gap-3">
            <span class="text-xs font-black uppercase tracking-wider text-slate-600 dark:text-slate-300 flex items-center gap-1.5">
              <span>📅</span> Date Range:
            </span>

            <!-- Preset Buttons -->
            <div class="flex flex-wrap items-center gap-1 bg-white dark:bg-slate-900 p-1 rounded-xl border border-slate-200 dark:border-slate-800">
              <button
                type="button"
                @click="setQuickRange('this_month')"
                :class="[
                  'px-3 py-1 rounded-lg text-xs font-extrabold transition-all cursor-pointer',
                  reportQuickRange === 'this_month' ? 'bg-blue-600 text-white shadow-xs' : 'text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-800'
                ]"
              >
                This Month
              </button>
              <button
                ...
                :class="[
                  'px-3 py-1 rounded-lg text-xs font-extrabold transition-all cursor-pointer',
                  reportQuickRange === 'last_month' ? 'bg-blue-600 text-white shadow-xs' : 'text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-800'
                ]"
              >
                Last Month
              </button>
              <button
                ...
                :class="[
                  'px-3 py-1 rounded-lg text-xs font-extrabold transition-all cursor-pointer',
                  reportQuickRange === 'this_year' ? 'bg-blue-600 text-white shadow-xs' : 'text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-800'
                ]"
              >
                This Year
              </button>
              <button
                ...
                :class="[
                  'px-3 py-1 rounded-lg text-xs font-extrabold transition-all cursor-pointer',
                  reportQuickRange === 'all_time' ? 'bg-blue-600 text-white shadow-xs' : 'text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-800'
                ]"
              >
                All Time
              </button>
          ...
          <div class="flex flex-wrap items-center gap-2 text-xs font-bold text-slate-700 dark:text-slate-200">
            <div class="flex items-center gap-1.5 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 px-3 py-1.5 rounded-xl shadow-xs">
              <span class="text-slate-400 font-medium">From:</span>
              <input
                type="date"
                v-model="reportStartDate"
                @change="reportQuickRange = 'custom'"
                class="bg-transparent font-mono text-xs text-slate-900 dark:text-white focus:outline-none cursor-pointer"
              />
            </div>
        ...
        <div v-if="!selectedReport" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          <!-- 1. Account Summary -->
          <div @click="navigateTo('reporting', 'account_summary')" class="bg-slate-50 dark:bg-slate-800/50 hover:bg-blue-50/50 dark:hover:bg-blue-950/50 p-5 rounded-2xl border border-slate-200 dark:border-slate-800 hover:border-blue-300 dark:hover:border-blue-700/60 transition-all cursor-pointer space-y-3 group">
            <div class="flex items-center justify-between">
              <span class="text-2xl group-hover:scale-110 transition-transform">📋</span>
              <span class="text-[10px] font-black uppercase tracking-wider bg-slate-200 dark:bg-slate-700 group-hover:bg-blue-200 dark:group-hover:bg-blue-900/60 group-hover:text-blue-900 dark:group-hover:text-blue-200 px-2 py-0.5 rounded-full text-slate-700 dark:text-slate-200">General Ledger</span>
            </div>
            <div>
              <h4 class="font-extrabold text-slate-900 dark:text-white text-sm group-hover:text-blue-800 dark:group-hover:text-blue-200">Account Summary</h4>
              <p class="text-xs text-slate-500 dark:text-slate-400 mt-1">Full activity debit/credit summary across chart of accounts.</p>
            </div>
          ...
          <div @click="navigateTo('reporting', 'aged_payables')" class="bg-slate-50 dark:bg-slate-800/50 hover:bg-blue-50/50 dark:hover:bg-blue-950/50 p-5 rounded-2xl border border-slate-200 dark:border-slate-800 hover:border-blue-300 dark:hover:border-blue-700/60 transition-all cursor-pointer space-y-3 group">
            <div class="flex items-center justify-between">
              <span class="text-2xl group-hover:scale-110 transition-transform">📉</span>
              <span class="text-[10px] font-black uppercase tracking-wider bg-amber-100 dark:bg-amber-900/40 text-amber-800 dark:text-amber-200 px-2 py-0.5 rounded-full">Payables</span>
            </div>
            <div>
              <h4 class="font-extrabold text-slate-900 dark:text-white text-sm group-hover:text-blue-800 dark:group-hover:text-blue-200">Aged Payables Summary</h4>
              <p class="text-xs text-slate-500 dark:text-slate-400 mt-1">Outstanding vendor bills grouped by 0-30, 31-60, 61-90, 90+ days.</p>
            </div>
            <div class="pt-2 border-t border-slate-200/60 dark:border-slate-800/60 flex items-center justify-between text-xs font-bold text-amber-700 dark:text-amber-300">
          ...
          <div @click="navigateTo('reporting', 'aged_receivables')" class="bg-slate-50 dark:bg-slate-800/50 hover:bg-blue-50/50 dark:hover:bg-blue-950/50 p-5 rounded-2xl border border-slate-200 dark:border-slate-800 hover:border-blue-300 dark:hover:border-blue-700/60 transition-all cursor-pointer space-y-3 group">
            <div class="flex items-center justify-between">
              <span class="text-2xl group-hover:scale-110 transition-transform">📈</span>
              <span class="text-[10px] font-black uppercase tracking-wider bg-emerald-100 dark:bg-emerald-900/40 text-emerald-800 dark:text-emerald-200 px-2 py-0.5 rounded-full">Receivables</span>
            </div>
            <div>
              <h4 class="font-extrabold text-slate-900 dark:text-white text-sm group-hover:text-blue-800 dark:group-hover:text-blue-200">Aged Receivables Summary</h4>
              <p class="text-xs text-slate-500 dark:text-slate-400 mt-1">Outstanding member dues & invoices grouped by aging buckets.</p>
            </div>
            <div class="pt-2 border-t border-slate-200/60 dark:border-slate-800/60 flex items-center justify-between text-xs font-bold text-emerald-700 dark:text-emerald-300">
          ...
          <!-- 4. Balance Sheet -->
          <div @click="navigateTo('reporting', 'balance_sheet')" class="bg-slate-50 dark:bg-slate-800/50 hover:bg-blue-50/50 dark:hover:bg-blue-950/50 p-5 rounded-2xl border border-slate-200 dark:border-slate-800 hover:border-blue-300 dark:hover:border-blue-700/60 transition-all cursor-pointer space-y-3 group">
            <div class="flex items-center justify-between">
              <span class="text-2xl group-hover:scale-110 transition-transform">⚖️</span>
              <span class="text-[10px] font-black uppercase tracking-wider bg-blue-100 dark:bg-blue-900/40 text-blue-800 dark:text-blue-200 px-2 py-0.5 rounded-full">Statement</span>
            </div>
            <div>
              <h4 class="font-extrabold text-slate-900 dark:text-white text-sm group-hover:text-blue-800 dark:group-hover:text-blue-200">Balance Sheet</h4>
              <p class="text-xs text-slate-500 dark:text-slate-400 mt-1">Assets, liabilities, and retained club equity balance statement.</p>
            </div>
            <div class="pt-2 border-t border-slate-200/60 dark:border-slate-800/60 flex items-center justify-between text-xs font-bold text-blue-700 dark:text-blue-300">
          ...
          <!-- 5. Cash Summary -->
          <div @click="navigateTo('reporting', 'cash_summary')" class="bg-slate-50 dark:bg-slate-800/50 hover:bg-blue-50/50 dark:hover:bg-blue-950/50 p-5 rounded-2xl border border-slate-200 dark:border-slate-800 hover:border-blue-300 dark:hover:border-blue-700/60 transition-all cursor-pointer space-y-3 group">
            <div class="flex items-center justify-between">
              <span class="text-2xl group-hover:scale-110 transition-transform">💵</span>
              <span class="text-[10px] font-black uppercase tracking-wider bg-blue-100 dark:bg-blue-900/40 text-blue-800 dark:text-blue-200 px-2 py-0.5 rounded-full">Cash Flow</span>
            </div>
            <div>
              <h4 class="font-extrabold text-slate-900 dark:text-white text-sm group-hover:text-blue-800 dark:group-hover:text-blue-200">Cash Summary</h4>
              <p class="text-xs text-slate-500 dark:text-slate-400 mt-1">Net cash position in bank and petty cash operating accounts.</p>
            </div>
            <div class="pt-2 border-t border-slate-200/60 dark:border-slate-800/60 flex items-center justify-between text-xs font-bold text-blue-700 dark:text-blue-300">
          ...
          <!-- 6. Executive Summary -->
          <div @click="navigateTo('reporting', 'executive_summary')" class="bg-slate-50 dark:bg-slate-800/50 hover:bg-blue-50/50 dark:hover:bg-blue-950/50 p-5 rounded-2xl border border-slate-200 dark:border-slate-800 hover:border-blue-300 dark:hover:border-blue-700/60 transition-all cursor-pointer space-y-3 group">
            <div class="flex items-center justify-between">
              <span class="text-2xl group-hover:scale-110 transition-transform">📊</span>
              <span class="text-[10px] font-black uppercase tracking-wider bg-blue-100 dark:bg-blue-900/40 text-blue-800 dark:text-blue-200 px-2 py-0.5 rounded-full">KPI Ratios</span>
            </div>
            <div>
              <h4 class="font-extrabold text-slate-900 dark:text-white text-sm group-hover:text-blue-800 dark:group-hover:text-blue-200">Executive Summary</h4>
              <p class="text-xs text-slate-500 dark:text-slate-400 mt-1">Key financial performance metrics, profit margins & ratios.</p>
            </div>
            <div class="pt-2 border-t border-slate-200/60 dark:border-slate-800/60 flex items-center justify-between text-xs font-bold text-blue-700 dark:text-blue-300">
          ...
          <!-- 7. Profit and Loss -->
          <div @click="navigateTo('reporting', 'profit_and_loss')" class="bg-slate-50 dark:bg-slate-800/50 hover:bg-blue-50/50 dark:hover:bg-blue-950/50 p-5 rounded-2xl border border-slate-200 dark:border-slate-800 hover:border-blue-300 dark:hover:border-blue-700/60 transition-all cursor-pointer space-y-3 group">
            <div class="flex items-center justify-between">
              <span class="text-2xl group-hover:scale-110 transition-transform">🧾</span>
              <span class="text-[10px] font-black uppercase tracking-wider bg-emerald-100 dark:bg-emerald-900/40 text-emerald-800 dark:text-emerald-200 px-2 py-0.5 rounded-full">P&L</span>
            </div>
            <div>
              <h4 class="font-extrabold text-slate-900 dark:text-white text-sm group-hover:text-blue-800 dark:group-hover:text-blue-200">Profit and Loss (P&L)</h4>
              <p class="text-xs text-slate-500 dark:text-slate-400 mt-1">Detailed revenue income minus operating expenses statement.</p>
            </div>
            <div class="pt-2 border-t border-slate-200/60 dark:border-slate-800/60 flex items-center justify-between text-xs font-bold text-emerald-700 dark:text-emerald-300">
          ...
          <div @click="navigateTo('reporting', 'comparative_income_expenditure')" class="bg-slate-50 dark:bg-slate-800/50 hover:bg-blue-50/50 dark:hover:bg-blue-950/50 p-5 rounded-2xl border border-slate-200 dark:border-slate-800 hover:border-blue-300 dark:hover:border-blue-700/60 transition-all cursor-pointer space-y-3 group">
            <div class="flex items-center justify-between">
              <span class="text-2xl group-hover:scale-110 transition-transform">🏛️</span>
              <span class="text-[10px] font-black uppercase tracking-wider bg-amber-100 dark:bg-amber-900/40 text-amber-900 dark:text-amber-200 px-2 py-0.5 rounded-full">Annual Statement</span>
            </div>
            <div>
              <h4 class="font-extrabold text-slate-900 dark:text-white text-sm group-hover:text-blue-800 dark:group-hover:text-blue-200">Comparative Income & Expenditure</h4>
          ...
          <div @click="navigateTo('reporting', 'reconciliation_summary')" class="bg-slate-50 dark:bg-slate-800/50 hover:bg-blue-50/50 dark:hover:bg-blue-950/50 p-5 rounded-2xl border border-slate-200 dark:border-slate-800 hover:border-blue-300 dark:hover:border-blue-700/60 transition-all cursor-pointer space-y-3 group">
            <div class="flex items-center justify-between">
              <span class="text-2xl group-hover:scale-110 transition-transform">💳</span>
              <span class="text-[10px] font-black uppercase tracking-wider bg-blue-100 dark:bg-blue-900/40 text-blue-900 dark:text-blue-200 px-2 py-0.5 rounded-full">Bank Audit</span>
            </div>
            <div>
              <h4 class="font-extrabold text-slate-900 dark:text-white text-sm group-hover:text-blue-800 dark:group-hover:text-blue-200">Bank Reconciliation Summary</h4>
        ...
        <div v-else class="space-y-6">
          ...
          <div v-if="selectedReport === 'account_summary'" class="space-y-4">
            <div class="flex items-center justify-between">
              <h4 class="text-base font-extrabold text-slate-900 dark:text-white">Account Summary Report</h4>
            ...
            <div class="overflow-x-auto border border-slate-200 dark:border-slate-800 rounded-2xl">
              <table class="w-full text-left border-collapse text-xs">
                ...
                <tbody class="divide-y divide-slate-100 dark:divide-slate-800 font-semibold text-slate-700 dark:text-slate-200">
                  <tr v-for="acc in reports.account_summary" :key="acc.code" class="hover:bg-slate-50 dark:hover:bg-slate-800/50">
                    <td class="py-2.5 px-4 font-mono font-bold text-slate-900 dark:text-white">{{ acc.code }}</td>
                    <td class="py-2.5 px-4 font-bold text-slate-900 dark:text-white">{{ acc.name }}</td>
                    ...
                    <td class="py-2.5 px-4 text-right font-mono font-black text-slate-900 dark:text-white">{{ formatCurrency(acc.net_balance) }}</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <div v-if="selectedReport === 'aged_payables'" class="space-y-4">
            <div class="flex items-center justify-between">
              <h4 class="text-base font-extrabold text-slate-900 dark:text-white">Aged Payables Summary</h4>
              <span class="text-xs font-semibold text-amber-700 dark:text-amber-300 font-mono">Total Outstanding: {{ formatCurrency(reports.aged_payables.total) }}</span>
            </div>
            <div class="grid grid-cols-2 sm:grid-cols-5 gap-3 text-center text-xs">
              <div class="p-3 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-200 dark:border-slate-800">
                <span class="text-[10px] font-bold text-slate-400 block uppercase">Current</span>
                <span class="font-black text-slate-800 dark:text-slate-100 text-sm block">{{ formatCurrency(reports.aged_payables.current) }}</span>
              </div>
              <div class="p-3 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-200 dark:border-slate-800">
                <span class="text-[10px] font-bold text-slate-400 block uppercase">1 - 30 Days</span>
                <span class="font-black text-amber-700 dark:text-amber-300 text-sm block">{{ formatCurrency(reports.aged_payables['1_30']) }}</span>
              </div>
              <div class="p-3 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-200 dark:border-slate-800">
                <span class="text-[10px] font-bold text-slate-400 block uppercase">31 - 60 Days</span>
                <span class="font-black text-amber-800 dark:text-amber-200 text-sm block">{{ formatCurrency(reports.aged_payables['31_60']) }}</span>
              </div>
              <div class="p-3 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-200 dark:border-slate-800">
                <span class="text-[10px] font-bold text-slate-400 block uppercase">61 - 90 Days</span>
                <span class="font-black text-rose-700 dark:text-rose-300 text-sm block">{{ formatCurrency(reports.aged_payables['61_90']) }}</span>
              </div>
              <div class="p-3 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-200 dark:border-slate-800">
                <span class="text-[10px] font-bold text-slate-400 block uppercase">90+ Days</span>
                <span class="font-black text-rose-900 dark:text-rose-200 text-sm block">{{ formatCurrency(reports.aged_payables['90_plus']) }}</span>
              </div>
            </div>
            <div class="overflow-x-auto border border-slate-200 dark:border-slate-800 rounded-2xl">
              <table class="w-full text-left border-collapse text-xs">
                ...
                <tbody class="divide-y divide-slate-100 dark:divide-slate-800 font-semibold text-slate-700 dark:text-slate-200">
                  ...
                  <tr v-for="b in reports.aged_payables.items" :key="b.bill_number" class="hover:bg-slate-50 dark:hover:bg-slate-800/50">
                    <td class="py-2.5 px-4 font-mono font-bold text-slate-900 dark:text-white">{{ b.bill_number }}</td>
                    <td class="py-2.5 px-4 font-bold text-slate-900 dark:text-white">{{ b.vendor_name }}</td>
                    <td class="py-2.5 px-4 text-slate-500 dark:text-slate-400">{{ b.due_date }}</td>
                    <td class="py-2.5 px-4">
          ...
          <div v-if="selectedReport === 'aged_receivables'" class="space-y-4">
            <div class="flex items-center justify-between">
              <h4 class="text-base font-extrabold text-slate-900 dark:text-white">Aged Receivables Summary</h4>
              <span class="text-xs font-semibold text-emerald-700 dark:text-emerald-300 font-mono">Total Outstanding: {{ formatCurrency(reports.aged_receivables.total) }}</span>
            </div>
            <div class="grid grid-cols-2 sm:grid-cols-5 gap-3 text-center text-xs">
              <div class="p-3 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-200 dark:border-slate-800">
                <span class="text-[10px] font-bold text-slate-400 block uppercase">Current</span>
                <span class="font-black text-slate-800 dark:text-slate-100 text-sm block">{{ formatCurrency(reports.aged_receivables.current) }}</span>
              </div>
              <div class="p-3 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-200 dark:border-slate-800">
                <span class="text-[10px] font-bold text-slate-400 block uppercase">1 - 30 Days</span>
                <span class="font-black text-emerald-700 dark:text-emerald-300 text-sm block">{{ formatCurrency(reports.aged_receivables['1_30']) }}</span>
              </div>
              <div class="p-3 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-200 dark:border-slate-800">
                <span class="text-[10px] font-bold text-slate-400 block uppercase">31 - 60 Days</span>
                <span class="font-black text-amber-700 dark:text-amber-300 text-sm block">{{ formatCurrency(reports.aged_receivables['31_60']) }}</span>
              </div>
              <div class="p-3 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-200 dark:border-slate-800">
                <span class="text-[10px] font-bold text-slate-400 block uppercase">61 - 90 Days</span>
                <span class="font-black text-rose-700 dark:text-rose-300 text-sm block">{{ formatCurrency(reports.aged_receivables['61_90']) }}</span>
              </div>
              <div class="p-3 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-200 dark:border-slate-800">
                <span class="text-[10px] font-bold text-slate-400 block uppercase">90+ Days</span>
                <span class="font-black text-rose-900 dark:text-rose-200 text-sm block">{{ formatCurrency(reports.aged_receivables['90_plus']) }}</span>
              </div>
            </div>
            <div class="overflow-x-auto border border-slate-200 dark:border-slate-800 rounded-2xl">
              <table class="w-full text-left border-collapse text-xs">
                ...
                <tbody class="divide-y divide-slate-100 dark:divide-slate-800 font-semibold text-slate-700 dark:text-slate-200">
                  ...
                  <tr v-for="inv in reports.aged_receivables.items" :key="inv.invoice_number" class="hover:bg-slate-50 dark:hover:bg-slate-800/50">
                    <td class="py-2.5 px-4 font-mono font-bold text-slate-900 dark:text-white">{{ inv.invoice_number }}</td>
                    <td class="py-2.5 px-4 font-bold text-slate-900 dark:text-white">{{ inv.recipient_name }}</td>
                    <td class="py-2.5 px-4 text-slate-500 dark:text-slate-400">{{ inv.created_at }}</td>
                    <td class="py-2.5 px-4">
          ...
          <div v-if="selectedReport === 'balance_sheet'" class="space-y-4">
            <div class="flex items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-2">
              <h4 class="text-base font-extrabold text-slate-900 dark:text-white">Balance Sheet Statement</h4>
              <span class="text-xs font-extrabold text-blue-700 dark:text-blue-300 font-mono">Assets = Liabilities + Equity</span>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-xs">
              <div class="bg-emerald-50/50 dark:bg-emerald-950/50 p-4 rounded-2xl border border-emerald-100 dark:border-emerald-900/40 space-y-3">
                <span class="font-extrabold text-emerald-900 dark:text-emerald-200 text-sm block">Assets</span>
                <div class="space-y-1.5">
                  <div v-for="a in reports.balance_sheet.assets" :key="a.code" class="flex justify-between border-b border-emerald-100 dark:border-emerald-900/40 pb-1">
                    <span class="font-semibold text-slate-700 dark:text-slate-200">{{ a.code }} - {{ a.name }}</span>
                    <span class="font-mono font-bold">{{ formatCurrency(a.balance) }}</span>
                  </div>
                </div>
                <div class="pt-2 flex justify-between font-black text-emerald-900 dark:text-emerald-200 text-sm border-t border-emerald-200 dark:border-emerald-800/60">
                  <span>Total Assets</span>
                  <span>{{ formatCurrency(reports.balance_sheet.total_assets) }}</span>
                </div>
              </div>

              <div class="bg-amber-50/50 dark:bg-amber-950/50 p-4 rounded-2xl border border-amber-100 dark:border-amber-900/40 space-y-3">
                <span class="font-extrabold text-amber-900 dark:text-amber-200 text-sm block">Liabilities</span>
                <div class="space-y-1.5">
                  <div v-for="l in reports.balance_sheet.liabilities" :key="l.code" class="flex justify-between border-b border-amber-100 dark:border-amber-900/40 pb-1">
                    <span class="font-semibold text-slate-700 dark:text-slate-200">{{ l.code }} - {{ l.name }}</span>
                    <span class="font-mono font-bold">{{ formatCurrency(l.balance) }}</span>
                  </div>
                </div>
                <div class="pt-2 flex justify-between font-black text-amber-900 dark:text-amber-200 text-sm border-t border-amber-200 dark:border-amber-800/60">
                  <span>Total Liabilities</span>
                  <span>{{ formatCurrency(reports.balance_sheet.total_liabilities) }}</span>
                </div>
              </div>

              <div class="bg-blue-50/50 dark:bg-blue-950/50 p-4 rounded-2xl border border-blue-100 dark:border-blue-900/40 space-y-3">
                <span class="font-extrabold text-blue-900 dark:text-blue-200 text-sm block">Club Equity</span>
                <div class="space-y-1.5">
                  <div v-for="e in reports.balance_sheet.equity" :key="e.code" class="flex justify-between border-b border-blue-100 dark:border-blue-900/40 pb-1">
                    <span class="font-semibold text-slate-700 dark:text-slate-200">{{ e.code }} - {{ e.name }}</span>
                    <span class="font-mono font-bold">{{ formatCurrency(e.balance) }}</span>
                  </div>
                </div>
                <div class="pt-2 flex justify-between font-black text-blue-900 dark:text-blue-200 text-sm border-t border-blue-200 dark:border-blue-800/60">
          ...
          <div v-if="selectedReport === 'cash_summary'" class="space-y-4">
            <div class="flex items-center justify-between">
              <h4 class="text-base font-extrabold text-slate-900 dark:text-white">Cash & Bank Accounts Summary</h4>
              <span class="text-xs font-black text-blue-800 dark:text-blue-200 font-mono">Net Cash Reserve: {{ formatCurrency(reports.cash_summary.total_cash_on_hand) }}</span>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
              <div v-for="acc in reports.cash_summary.accounts" :key="acc.code" class="p-4 bg-slate-50 dark:bg-slate-800/50 rounded-2xl border border-slate-200 dark:border-slate-800 flex items-center justify-between">
                <div>
                  <span class="font-mono font-bold text-blue-700 dark:text-blue-300 block">{{ acc.code }}</span>
                  <span class="font-bold text-slate-900 dark:text-white text-sm block">{{ acc.name }}</span>
                </div>
                <span class="text-base font-black font-mono text-emerald-700 dark:text-emerald-300">{{ formatCurrency(acc.balance) }}</span>
              </div>
            </div>
          </div>
          ...
          <div v-if="selectedReport === 'executive_summary'" class="space-y-4">
            <div class="flex items-center justify-between">
              <h4 class="text-base font-extrabold text-slate-900 dark:text-white">Executive Summary & Financial Ratios</h4>
              <span class="text-xs font-semibold text-blue-700 dark:text-blue-300 font-mono">Executive Financial Health</span>
            </div>
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-xs">
              <div class="p-4 bg-slate-50 dark:bg-slate-800/50 rounded-2xl border border-slate-200 dark:border-slate-800 space-y-1">
                <span class="text-[10px] font-bold text-slate-400 uppercase block">Net Profit Margin</span>
                <span class="text-xl font-black text-emerald-700 dark:text-emerald-300 block">{{ reports.executive_summary.net_profit_margin_pct }}%</span>
              </div>
              <div class="p-4 bg-slate-50 dark:bg-slate-800/50 rounded-2xl border border-slate-200 dark:border-slate-800 space-y-1">
                <span class="text-[10px] font-bold text-slate-400 uppercase block">Operating Expense Ratio</span>
                <span class="text-xl font-black text-blue-700 dark:text-blue-300 block">{{ reports.executive_summary.operating_expense_ratio_pct }}%</span>
              </div>
              <div class="p-4 bg-slate-50 dark:bg-slate-800/50 rounded-2xl border border-slate-200 dark:border-slate-800 space-y-1">
                <span class="text-[10px] font-bold text-slate-400 uppercase block">Total Receivables (A/R)</span>
                <span class="text-xl font-black text-amber-700 dark:text-amber-300 block">{{ formatCurrency(reports.executive_summary.outstanding_ar) }}</span>
              </div>
              <div class="p-4 bg-slate-50 dark:bg-slate-800/50 rounded-2xl border border-slate-200 dark:border-slate-800 space-y-1">
                <span class="text-[10px] font-bold text-slate-400 uppercase block">Total Payables (A/P)</span>
                <span class="text-xl font-black text-rose-700 dark:text-rose-300 block">{{ formatCurrency(reports.executive_summary.outstanding_ap) }}</span>
              </div>
            </div>
          </div>
          ...
          <div v-if="selectedReport === 'profit_and_loss'" class="space-y-4">
            <div class="flex items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-2">
              <h4 class="text-base font-extrabold text-slate-900 dark:text-white">Profit and Loss (Income Statement)</h4>
              <span class="text-xs font-black font-mono" :class="reports.profit_and_loss.net_income >= 0 ? 'text-emerald-700 dark:text-emerald-300' : 'text-rose-700 dark:text-rose-300'">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 text-xs">
              <!-- Revenue Section -->
              <div class="bg-blue-50/50 dark:bg-blue-950/50 p-4 rounded-2xl border border-blue-100 dark:border-blue-900/40 space-y-3">
                <span class="font-extrabold text-blue-900 dark:text-blue-200 text-sm block">Revenues & Operating Income</span>
                <div class="space-y-1.5">
                  <div v-for="r in reports.profit_and_loss.revenues" :key="r.code" class="flex justify-between border-b border-blue-100 dark:border-blue-900/40 pb-1">
                    <span class="font-semibold text-slate-700 dark:text-slate-200">{{ r.code }} - {{ r.name }}</span>
              ...
              <!-- Expense Section -->
              <div class="bg-rose-50/50 dark:bg-rose-950/50 p-4 rounded-2xl border border-rose-100 dark:border-rose-900/40 space-y-3">
                <span class="font-extrabold text-rose-900 dark:text-rose-200 text-sm block">Operating Expenses</span>
                <div class="space-y-1.5">
                  <div v-for="ex in reports.profit_and_loss.expenses" :key="ex.code" class="flex justify-between border-b border-rose-100 dark:border-rose-900/40 pb-1">
                    <span class="font-semibold text-slate-700 dark:text-slate-200">{{ ex.code }} - {{ ex.name }}</span>
                    <span class="font-mono font-bold">{{ formatCurrency(ex.amount) }}</span>
                  </div>
                </div>
                <div class="pt-2 flex justify-between font-black text-rose-900 dark:text-rose-200 text-sm border-t border-rose-200 dark:border-rose-800/60">
            ...
            <div class="overflow-x-auto border border-slate-200 dark:border-slate-800 rounded-2xl shadow-sm">
              <table class="w-full text-left border-collapse text-xs">
                ...
                <tbody class="divide-y divide-slate-200 dark:divide-slate-800 font-semibold text-slate-700 dark:text-slate-200 bg-white dark:bg-slate-900">
                  <tr v-for="(row, idx) in (reports.comparative_income_expenditure?.rows || [])" :key="idx" class="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                    <td class="py-3 px-4 font-bold text-slate-900 dark:text-white">{{ row.category }}</td>
                    <td class="py-3 px-4 text-right font-mono">{{ row.prior_income > 0 ? formatCurrency(row.prior_income) : '—' }}</td>
                    <td class="py-3 px-4 text-right font-mono text-slate-600 dark:text-slate-300">{{ row.prior_expenditure > 0 ? formatCurrency(row.prior_expenditure) : '—' }}</td>
                    <td class="py-3 px-4 text-right font-mono font-bold text-emerald-700 dark:text-emerald-300 border-l border-slate-100 dark:border-slate-800">{{ row.current_income > 0 ? formatCurrency(row.current_income) : '—' }}</td>
                    <td class="py-3 px-4 text-right font-mono text-slate-600 dark:text-slate-300">{{ row.current_expenditure > 0 ? formatCurrency(row.current_expenditure) : '—' }}</td>
                  </tr>
          ...
          <div v-if="selectedReport === 'reconciliation_summary'" class="space-y-6">
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-slate-50 dark:bg-slate-800/50 p-6 rounded-2xl border border-slate-200 dark:border-slate-800">
              <div>
                <span class="text-[10px] font-black uppercase tracking-wider text-blue-700 dark:text-blue-300 bg-blue-100 dark:bg-blue-900/40 px-2.5 py-1 rounded-full border border-blue-200 dark:border-blue-800/60">
              ...
              <div class="flex items-center gap-2">
                <button type="button" @click="window.print()" class="px-4 py-2 bg-slate-900 dark:bg-slate-700 hover:bg-slate-800 dark:hover:bg-slate-600 text-white font-extrabold text-xs rounded-xl transition-all cursor-pointer shadow-sm flex items-center gap-1.5">
                  🖨️ Print / Export PDF
                </button>
              </div>
            </div>
      ...
      <div v-if="activeTab === 'accounting' || activeTab === 'bank-accounts'" class="space-y-6">
          ...
          <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-100 dark:border-slate-800 pb-5">
            <div>
              <div class="flex items-center gap-2.5">
                ...
                <h3 class="text-lg font-extrabold text-slate-900 dark:text-white">Bank &amp; Payment Accounts Hub</h3>
              </div>
            ...
            <div class="relative connect-bank-dropdown-container">
              <button
                ...
                class="px-4 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-xl shadow-md transition-all cursor-pointer font-extrabold text-xs flex items-center gap-2"
              >
              ...
              <div
                ...
                class="absolute right-0 mt-2 w-64 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-xl py-2 z-40 text-xs font-semibold text-slate-800 dark:text-slate-100 space-y-1 divide-y divide-slate-100 dark:divide-slate-800"
              >
                ...
                <div class="py-1">
                  <button
                    ...
                    class="w-full text-left px-4 py-2 hover:bg-slate-50 dark:hover:bg-slate-800/50 flex items-center gap-2.5 transition-colors cursor-pointer"
                  >
                    <span class="text-base">🏦</span>
                    <div>
                      <span class="font-bold text-slate-900 dark:text-white block">High Street Bank Account</span>
                      <span class="text-[10px] text-slate-500 dark:text-slate-400 font-medium">Current, Savings or Cash Account</span>
                    </div>
                  </button>
                  ...
                  <button
                    ...
                    class="w-full text-left px-4 py-2 hover:bg-amber-50/70 dark:hover:bg-amber-950/70 flex items-center gap-2.5 transition-colors cursor-pointer"
                  >
                    <span class="text-base">🟡</span>
                    <div>
                      <span class="font-bold text-slate-900 dark:text-white block">GoCardless Direct Debit API</span>
                      <span class="text-[10px] text-amber-700 dark:text-amber-300 font-medium">Direct Debit Mandates &amp; Feed</span>
                    </div>
                  </button>
                  ...
                  <button
                    ...
                    class="w-full text-left px-4 py-2 hover:bg-blue-50/70 dark:hover:bg-blue-950/70 flex items-center gap-2.5 transition-colors cursor-pointer"
                  >
                    <span class="text-base">💜</span>
                    <div>
                      <span class="font-bold text-slate-900 dark:text-white block">Stripe API</span>
                      <span class="text-[10px] text-blue-700 dark:text-blue-300 font-medium">Card Payments &amp; Payout Feed</span>
                    </div>
                  </button>
                  ...
                  <button
                    ...
                    class="w-full text-left px-4 py-2 hover:bg-emerald-50/70 dark:hover:bg-emerald-950/70 flex items-center gap-2.5 transition-colors cursor-pointer"
                  >
                    <span class="text-base">💚</span>
                    <div>
                      <span class="font-bold text-slate-900 dark:text-white block">SumUp Card Reader API</span>
                      <span class="text-[10px] text-emerald-700 dark:text-emerald-300 font-medium">Card Terminal Sales Feed</span>
                    </div>
                  </button>
                  ...
                  >
                    <span class="text-base">🟦</span>
                    <div>
                      <span class="font-bold text-slate-900 dark:text-white block">PayPal Merchant API</span>
                      <span class="text-[10px] text-blue-700 dark:text-blue-300 font-medium">PayPal Checkout Feed</span>
                    </div>
                  </button>
                </div>
              </div>
            ...
            >
              <div>
                <div class="flex items-start justify-between gap-2">
                  <div class="flex items-center gap-2.5">
                    <div class="w-10 h-10 rounded-xl flex items-center justify-center text-lg font-bold bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-slate-800 dark:text-slate-100 shadow-sm">
                    ...
                    <div>
                      <h4 class="font-extrabold text-slate-900 dark:text-white text-sm leading-snug">{{ acc.bank_name }}</h4>
                      <p class="text-[11px] font-semibold text-slate-500 dark:text-slate-400">{{ acc.account_name }}</p>
                    </div>
                  </div>

                  <span :class="['px-2 py-0.5 rounded-full text-[10px] font-extrabold uppercase tracking-wide border', acc.is_active ? 'bg-emerald-50 dark:bg-emerald-950/40 text-emerald-700 dark:text-emerald-300 border-emerald-200 dark:border-emerald-800/60' : 'bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 border-slate-200 dark:border-slate-800']">
                    {{ acc.is_active ? 'Active' : 'Inactive' }}
                  </span>
                </div>

                <div class="mt-3 pt-2.5 border-t border-slate-200/60 dark:border-slate-800/60 grid grid-cols-2 gap-2 text-[11px]">
                  <div>
                    <span class="text-[9px] font-bold text-slate-400 uppercase block">Account Type</span>
                    <span class="font-bold text-slate-700 dark:text-slate-200">{{ acc.formatted_account_type || acc.account_type }}</span>
                  </div>
                  <div>
                    <span class="text-[9px] font-bold text-slate-400 uppercase block">Nominal Code</span>
                    <span class="font-mono font-bold text-blue-600 dark:text-blue-400">Code {{ acc.account_code || '1000' }}</span>
                  </div>
                  <div v-if="acc.sort_code || acc.account_number" class="col-span-2 text-[10px] text-slate-500 dark:text-slate-400 font-mono">
                    <span>Sort: {{ acc.sort_code || 'N/A' }}</span> | <span>Acc: {{ acc.account_number || 'N/A' }}</span>
                  </div>
                </div>

                <!-- GoCardless API Badge -->
                <div v-if="acc.bank_name === 'GoCardless' || acc.gocardless_access_token" class="mt-2.5 p-2 bg-amber-50/90 dark:bg-amber-950/90 rounded-xl border border-amber-200 dark:border-amber-800/60 flex items-center justify-between text-[11px]">
                  <div>
                    <span class="font-bold text-amber-900 dark:text-amber-200 block">🟡 GoCardless API Active ({{ acc.gocardless_environment || 'sandbox' }})</span>
                    <span class="text-[10px] text-amber-700 dark:text-amber-300 font-medium">Direct Debit Payment Feed</span>
                  </div>
                  <button
                    type="button"
                ...
                <!-- Stripe API Badge -->
                <div v-else-if="acc.bank_name === 'Stripe' || acc.stripe_secret_key" class="mt-2.5 p-2 bg-blue-50/90 dark:bg-blue-950/90 rounded-xl border border-blue-200 dark:border-blue-800/60 flex items-center justify-between text-[11px]">
                  <div>
                    <span class="font-bold text-blue-900 dark:text-blue-200 block">🟢 Stripe API Sync Active</span>
                    <span class="text-[10px] text-blue-700 dark:text-blue-300 font-medium">Balance &amp; Payout Feed</span>
                  </div>
                  <button
                    type="button"
                ...
                <!-- SumUp API Badge -->
                <div v-else-if="acc.bank_name === 'SumUp' || acc.sumup_api_key" class="mt-2.5 p-2 bg-emerald-50/90 dark:bg-emerald-950/90 rounded-xl border border-emerald-200 dark:border-emerald-800/60 flex items-center justify-between text-[11px]">
                  <div>
                    <span class="font-bold text-emerald-900 dark:text-emerald-200 block">🟢 SumUp API Sync Active</span>
                    <span class="text-[10px] text-emerald-700 dark:text-emerald-300 font-medium">Card Reader Feed</span>
                  </div>
                  <button
                    type="button"
                ...
                <!-- PayPal API Badge -->
                <div v-else-if="acc.bank_name === 'PayPal' || acc.paypal_client_id" class="mt-2.5 p-2 bg-blue-50/90 dark:bg-blue-950/90 rounded-xl border border-blue-200 dark:border-blue-800/60 flex items-center justify-between text-[11px]">
                  <div>
                    <span class="font-bold text-blue-900 dark:text-blue-200 block">🟢 PayPal API Sync Active</span>
                    <span class="text-[10px] text-blue-700 dark:text-blue-300 font-medium">Env: {{ acc.paypal_environment || 'live' }}</span>
                  </div>
                  <button
                    type="button"
              ...
              <div class="pt-2 flex items-center justify-between gap-2 border-t border-slate-200/60 dark:border-slate-800/60 text-xs">
                <button
                  type="button"
                  @click="navigateTo('reconciliation', null, acc.id)"
                  :class="['px-3 py-1.5 rounded-xl font-bold transition-all flex items-center gap-1.5 cursor-pointer', acc.unreconciled_count > 0 ? 'bg-amber-500 hover:bg-amber-600 text-white shadow-sm' : 'bg-slate-200 dark:bg-slate-700 hover:bg-slate-300 text-slate-800 dark:text-slate-100']"
                >
                ...
                <button
                  ...
                  class="px-2.5 py-1 text-[11px] font-semibold text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-slate-100 cursor-pointer"
                >
        ...
        <div class="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden space-y-4">
          <div class="p-6 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between">
            <div>
              <h3 class="text-base font-extrabold text-slate-900 dark:text-white">General Ledger Journal Entries</h3>
              <p class="text-xs text-slate-500 dark:text-slate-400">Historical double-entry records posted to the ledger.</p>
            </div>
            <Link
              :href="route('admin.accounting.journal.create', club.slug)"
              class="px-3.5 py-1.5 bg-blue-600 hover:bg-blue-700 text-white font-bold text-xs rounded-xl transition-all"
            >
              + Add Journal Entry
            </Link>
          </div>
          ...
          <div class="p-6 space-y-4">
            <div v-if="!journalEntries.length" class="text-center py-12 border-2 border-dashed border-slate-200 dark:border-slate-800 rounded-2xl bg-slate-50 dark:bg-slate-800/50">
              <span class="text-3xl block mb-2">📖</span>
              <span class="text-xs font-bold text-slate-700 dark:text-slate-200 block">No Journal Entries Recorded</span>
            ...
            <div v-else class="space-y-4">
              ...
              >
                <div class="flex items-center justify-between text-xs border-b border-slate-200/60 dark:border-slate-800/60 pb-2">
                  <div class="flex items-center gap-3">
                    <span class="font-mono font-black text-blue-700 dark:text-blue-300 bg-blue-50 dark:bg-blue-950/40 px-2 py-0.5 rounded-md border border-blue-200 dark:border-blue-800/60">
                      {{ entry.reference_number }}
                    </span>
                    <span class="font-bold text-slate-900 dark:text-white">{{ entry.description }}</span>
                  </div>
                  <div class="flex items-center gap-3 text-slate-500 dark:text-slate-400 text-[11px] font-medium">
                    <span>📅 {{ entry.entry_date }}</span>
                    <span class="px-2 py-0.5 rounded bg-emerald-100 dark:bg-emerald-900/40 text-emerald-800 dark:text-emerald-200 font-bold uppercase text-[9px]">
                      {{ entry.status }}
                    </span>
                    <Link
                      :href="route('admin.accounting.journal.edit', { clubSlug: club.slug, id: entry.id })"
                      class="px-2 py-0.5 bg-white dark:bg-slate-900 hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-700 dark:text-slate-200 border border-slate-200 dark:border-slate-800 font-bold text-[10px] rounded-lg transition-colors"
                    >
                      Edit
                    </Link>
                  </div>
                ...
                <div class="overflow-x-auto">
                  <table class="w-full text-left text-xs">
                    ...
                    <tbody class="divide-y divide-slate-200/40 dark:divide-slate-800/40 text-[11px] font-semibold">
                      <tr v-for="item in entry.items" :key="item.id">
                        <td class="py-1.5 font-medium text-slate-800 dark:text-slate-100">
                          <span class="font-mono font-bold text-slate-500 dark:text-slate-400 mr-2">{{ item.account_code }}</span>
                          <span>{{ item.account_name }}</span>
                          <span v-if="item.memo" class="text-slate-400 ml-2 italic text-[10px]">({{ item.memo }})</span>
                        </td>
                        <td class="py-1.5 text-right font-mono text-slate-900 dark:text-white">
      ...
      <div v-if="activeTab === 'chart-of-accounts'" class="space-y-6">
        <div class="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden">
          <div class="p-6 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between">
            <div>
              <h3 class="text-base font-extrabold text-slate-900 dark:text-white">Chart of Accounts</h3>
              <p class="text-xs text-slate-500 dark:text-slate-400">Categorized nominal ledger accounts for club bookkeeping.</p>
            </div>
            <div class="flex items-center gap-2">
              <button
                type="button"
                @click="openOpeningBalanceModal()"
                class="px-3.5 py-1.5 bg-slate-900 dark:bg-slate-700 hover:bg-slate-800 dark:hover:bg-slate-600 text-white font-bold text-xs rounded-xl transition-all cursor-pointer flex items-center gap-1.5 shadow-sm"
              >
              ...
              <button
                ...
                class="px-3.5 py-1.5 bg-blue-600 hover:bg-blue-700 text-white font-bold text-xs rounded-xl transition-all cursor-pointer shadow-sm"
              >
                + Add Account
              </button>
            </div>
            ...
            <table class="w-full text-left border-collapse">
              ...
              <tbody class="divide-y divide-slate-100 dark:divide-slate-800 text-xs font-semibold text-slate-700 dark:text-slate-200">
                <tr v-for="acc in accounts" :key="acc.id" class="hover:bg-slate-50/80 dark:hover:bg-slate-800/50/80 transition-colors">
                  ...
                  <td class="py-3 px-6 text-right font-black text-slate-900 dark:text-white font-mono">
                    <div class="flex items-center justify-end gap-3">
                      <span>{{ acc.formatted_balance }}</span>
                      <button
                        type="button"
                        @click="openOpeningBalanceModal(acc.id)"
                        class="px-2.5 py-1 text-[10px] font-extrabold text-blue-700 dark:text-blue-300 bg-blue-50 dark:bg-blue-950/40 hover:bg-blue-100 dark:hover:bg-blue-900/40 rounded-lg border border-blue-200 dark:border-blue-800/60 transition-all cursor-pointer"
      ...
      <div v-if="activeTab === 'contacts'" class="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm p-6 space-y-6">
        <div class="border-b border-slate-100 dark:border-slate-800 pb-4 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <h3 class="text-lg font-black text-slate-900 dark:text-white">Contacts & Directory</h3>
        ...
        <div class="flex items-center gap-2 text-xs font-bold border-b border-slate-100 dark:border-slate-800 pb-3 overflow-x-auto">
          <button
            type="button"
            @click="contactFilter = 'all'"
            :class="['px-3 py-1.5 rounded-xl transition-all cursor-pointer', contactFilter === 'all' ? 'bg-slate-900 dark:bg-slate-700 text-white font-black' : 'bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700']"
          >
          ...
          <button
            ...
            :class="['px-3 py-1.5 rounded-xl transition-all cursor-pointer flex items-center gap-1.5', contactFilter === 'person' ? 'bg-blue-700 text-white font-black' : 'bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700']"
          >
          ...
          <button
            ...
            :class="['px-3 py-1.5 rounded-xl transition-all cursor-pointer flex items-center gap-1.5', contactFilter === 'member' ? 'bg-emerald-700 text-white font-black' : 'bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700']"
          >
          ...
          <table class="w-full text-left border-collapse">
            ...
            <tbody class="divide-y divide-slate-100 dark:divide-slate-800 text-xs font-semibold text-slate-700 dark:text-slate-200">
              ...
              <tr v-for="c in filteredContacts" :key="c.id" class="hover:bg-slate-50/80 dark:hover:bg-slate-800/50/80 transition-colors">
                  ...
                  <div class="flex items-center gap-2.5">
                    ...
                    <div>
                      <Link
                        ...
                        class="font-extrabold text-slate-900 dark:text-white hover:text-blue-700 dark:hover:text-blue-300 hover:underline text-left block cursor-pointer transition-colors"
                      ...
                      <span v-else class="font-extrabold text-slate-900 dark:text-white block">{{ c.name }}</span>
                      <span v-if="c.contact_person && c.contact_person !== c.name" class="text-[11px] text-slate-500 dark:text-slate-400 block">
                ...
                <td class="py-3 px-4">
                  <span class="px-2.5 py-0.5 rounded-full text-[10px] font-black uppercase tracking-wider border bg-blue-50 dark:bg-blue-950/40 text-blue-800 dark:text-blue-200 border-blue-200 dark:border-blue-800/60">
                    {{ c.kind === 'member' ? 'member' : 'person' }}
                  </span>
                </td>
                <td class="py-3 px-4">
                  <span class="px-2.5 py-0.5 rounded-lg text-[10px] font-black bg-slate-100 dark:bg-slate-800 text-slate-800 dark:text-slate-100 border border-slate-200 dark:border-slate-800">
                    {{ c.role }}
                  </span>
                </td>
                <td class="py-3 px-4">
                  <span class="font-mono text-slate-700 dark:text-slate-200 block">{{ c.email }}</span>
                  <span class="text-[11px] text-slate-500 dark:text-slate-400 block">{{ c.phone }}</span>
                </td>
                <td class="py-3 px-4 text-slate-600 dark:text-slate-300">
                ...
                <td class="py-3 px-4 text-center">
                  ...
                  <div v-else class="flex items-center justify-center gap-1.5">
                    <Link
                      :href="route('admin.accounting.contacts.edit', [club.slug, c.contact_db_id])"
                      class="px-2.5 py-1 bg-blue-50 dark:bg-blue-950/40 hover:bg-blue-100 dark:hover:bg-blue-900/40 text-blue-800 dark:text-blue-200 border border-blue-200 dark:border-blue-800/60 text-[10px] font-extrabold rounded-lg transition-all cursor-pointer"
                      title="Edit Contact"
                    >
                      Edit
                    </Link>
                    <Link
                      ...
                      class="px-2.5 py-1 bg-amber-50 dark:bg-amber-950/40 hover:bg-amber-100 dark:hover:bg-amber-900/40 text-amber-800 dark:text-amber-200 border border-amber-200 dark:border-amber-800/60 text-[10px] font-extrabold rounded-lg transition-all"
                    >
                      + Record Bill
                    </Link>
                  </div>
      ...
      <div v-if="activeTab === 'reconciliation'" class="space-y-4">
        ...
        <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-4 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div class="space-y-2">
            <div class="flex items-center gap-3">
              ...
              <div class="relative">
                <select
                  ...
                  class="bg-slate-50 dark:bg-slate-800/50 border border-slate-300 dark:border-slate-700 text-slate-900 dark:text-white font-black text-base rounded-xl px-3 py-1.5 focus:bg-white dark:focus:bg-slate-900 focus:ring-2 focus:ring-blue-500 cursor-pointer"
                >
                  <option
                    v-for="acc in (bankAccounts || [])"
                    :key="acc.id"
            ...
            <a href="#" @click.prevent="showWhatsThisModal = true" class="text-blue-600 dark:text-blue-400 text-xs font-semibold hover:underline inline-block mt-0.5">What's this?</a>
          </div>
          ...
          <div class="flex flex-wrap items-center gap-2.5 self-start md:self-auto">
            <button
              ...
              class="text-xs font-bold text-blue-600 dark:text-blue-400 hover:underline mr-2 cursor-pointer"
            >
            ...
            <div class="relative manage-account-container">
              <button
                ...
                class="px-3 py-1.5 bg-slate-900 dark:bg-slate-700 hover:bg-slate-800 dark:hover:bg-slate-600 text-white font-bold text-xs rounded-lg transition-all flex items-center gap-1 cursor-pointer"
              >
                <span>Manage Account</span>
                <span>▾</span>
              </button>
              <div v-if="showManageAccountMenu" class="absolute right-0 mt-1 w-48 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl shadow-lg py-1 z-30 text-xs font-semibold text-slate-700 dark:text-slate-200">
                <button type="button" @click="showImportModal = true; showManageAccountMenu = false" class="w-full text-left px-4 py-2 hover:bg-slate-50 dark:hover:bg-slate-800/50">📂 Import Bank Statement</button>
                <button type="button" @click="reconSubTab = 'bank_statements'; showManageAccountMenu = false" class="w-full text-left px-4 py-2 hover:bg-slate-50 dark:hover:bg-slate-800/50">📜 Bank Statement History</button>
                <button type="button" @click="reconSubTab = 'cash_coding'; showManageAccountMenu = false" class="w-full text-left px-4 py-2 hover:bg-slate-50 dark:hover:bg-slate-800/50">⚡ Bulk Cash Coding</button>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 flex flex-col sm:flex-row sm:items-center justify-between gap-2 px-1">
          <div class="flex items-center gap-1 overflow-x-auto text-xs font-bold">
            <button
              ...
              :class="[
                ...
                reconSubTab === 'reconcile' ? 'border-blue-600 text-blue-700 dark:text-blue-300 font-extrabold' : 'border-transparent text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-slate-100'
              ]"
            >
            ...
            <button
              ...
              :class="[
                'px-4 py-2.5 border-b-2 transition-all cursor-pointer whitespace-nowrap',
                reconSubTab === 'cash_coding' ? 'border-blue-600 text-blue-700 dark:text-blue-300 font-extrabold' : 'border-transparent text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-slate-100'
              ]"
            >
              Cash coding
            </button>
            ...
            <button
              ...
              :class="[
                'px-4 py-2.5 border-b-2 transition-all cursor-pointer whitespace-nowrap',
                reconSubTab === 'bank_statements' ? 'border-blue-600 text-blue-700 dark:text-blue-300 font-extrabold' : 'border-transparent text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-slate-100'
              ]"
            >
              Bank statements
            </button>
            ...
            <button
              ...
              :class="[
                'px-4 py-2.5 border-b-2 transition-all cursor-pointer whitespace-nowrap',
                reconSubTab === 'account_transactions' ? 'border-blue-600 text-blue-700 dark:text-blue-300 font-extrabold' : 'border-transparent text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-slate-100'
              ]"
            >
            ...
            <button
              ...
              :class="[
                ...
                reconSubTab === 'gift_aid' ? 'border-amber-600 text-amber-800 dark:text-amber-200 font-extrabold' : 'border-transparent text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-slate-100'
              ]"
            >
        ...
        <div class="space-y-2">
          <div class="flex flex-col sm:flex-row items-center justify-between gap-3 bg-white dark:bg-slate-900 p-2.5 rounded-xl border border-slate-200 dark:border-slate-800">
            <div class="relative w-full sm:flex-1">
              <input
                v-model="reconSearch"
                type="text"
                placeholder="Search for Payee, Amount, Reference, Description, Cheque No., or Analysis Code"
                class="w-full pl-8 pr-3 py-1.5 bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-800 rounded-lg text-xs text-slate-800 dark:text-slate-100 focus:bg-white dark:focus:bg-slate-900 focus:outline-none focus:ring-1 focus:ring-blue-500"
              />
            ...
            <button
              ...
              :class="[
                ...
                showFilterPanel ? 'bg-blue-50 dark:bg-blue-950/40 text-blue-800 dark:text-blue-200 border-blue-300 dark:border-blue-700/60' : 'bg-white dark:bg-slate-900 text-slate-700 dark:text-slate-200 border-slate-300 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-800/50'
              ]"
            >
              <span>🔻 Filter</span>
            </button>
          ...
          <div v-if="showFilterPanel" class="bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-800 rounded-xl p-4 grid grid-cols-1 sm:grid-cols-4 gap-3 text-xs">
            <div>
              <label class="font-bold text-slate-700 dark:text-slate-200 block mb-1">Transaction Type</label>
              <select v-model="filterType" class="w-full p-1.5 border border-slate-300 dark:border-slate-700 rounded bg-white dark:bg-slate-900">
            ...
            <div class="flex items-end">
              <button
                ...
                class="w-full py-1.5 bg-slate-200 dark:bg-slate-700 hover:bg-slate-300 text-slate-700 dark:text-slate-200 font-bold rounded"
              >
                Reset Filters
              </button>
            </div>
          ...
          <div class="space-y-4">
            ...
            >
              <div class="grid grid-cols-1 lg:grid-cols-12 gap-3 items-center">
                ...
                <div
                  :class="[
                    'lg:col-span-5 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-lg p-4 shadow-sm flex flex-col justify-between',
                ...
                >
                  <div>
                    <div class="flex items-center justify-between text-xs relative">
                      ...
                      <div class="relative statement-options-container">
                        <button
                          ...
                          class="text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-200 hover:underline font-medium focus:outline-none cursor-pointer"
                        >
                          Options ▾
                        </button>
                        ...
                        <div
                          ...
                          class="absolute right-0 top-5 z-30 w-48 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl shadow-xl py-1 text-xs font-semibold text-slate-700 dark:text-slate-200 animate-in fade-in duration-100"
                        >
                          <button
                            type="button"
                            @click="deleteSingleStatementLine(tx.id)"
                            class="w-full text-left px-3.5 py-2 text-rose-600 dark:text-rose-400 hover:bg-rose-50 dark:hover:bg-rose-950/40 flex items-center gap-2 cursor-pointer transition-colors"
                          >
                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="mt-1">
                      <h4 class="font-extrabold text-slate-900 dark:text-white text-sm leading-snug truncate">{{ tx.raw_description }}</h4>
                    ...
                    <div class="relative statement-details-container inline-block mt-1">
                      <a
                        ...
                        class="text-xs text-blue-600 dark:text-blue-400 hover:underline inline-block font-medium cursor-pointer"
                      >
                        More details
                      </a>
                      ...
                      <div
                        ...
                        class="absolute left-0 top-full mt-2.5 z-50 w-80 sm:w-96 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-lg shadow-2xl p-4 text-xs font-sans animate-in fade-in duration-100"
                        @click.stop
                      >
                        <!-- Top Pointer Arrow -->
                        <div class="absolute -top-1.5 left-6 w-3 h-3 bg-white dark:bg-slate-900 border-t border-l border-slate-300 dark:border-slate-700 rotate-45 z-10"></div>

                        <!-- Header -->
                        <div class="flex items-center justify-between pb-3">
                          <h3 class="text-sm font-extrabold text-slate-900 dark:text-white">Statement Details</h3>
                          <div class="flex items-center gap-2 text-[11px] text-slate-500 dark:text-slate-400">
                            <span>Esc to close</span>
                            <button
                              type="button"
                              @click="activeDetailsTxId = null"
                              class="text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 font-bold text-sm cursor-pointer focus:outline-none"
                            >
                              ✕
                            </button>
                          </div>
                        ...
                        <!-- Details Table -->
                        <table class="w-full border-collapse border border-slate-200 dark:border-slate-800 text-xs">
                          <tbody>
                            <tr>
                              <td class="w-1/2 border border-slate-200 dark:border-slate-800 p-2 text-right text-slate-600 dark:text-slate-300 font-normal">Transaction Date</td>
                              <td class="w-1/2 border border-slate-200 dark:border-slate-800 p-2 text-left text-slate-900 dark:text-white font-medium">{{ tx.transaction_date }}</td>
                            </tr>
                            <tr>
                              <td class="border border-slate-200 dark:border-slate-800 p-2 text-right text-slate-600 dark:text-slate-300 font-normal">Payee</td>
                              <td class="border border-slate-200 dark:border-slate-800 p-2 text-left text-slate-900 dark:text-white font-medium">{{ tx.payee || '' }}</td>
                            </tr>
                            <tr>
                              <td class="border border-slate-200 dark:border-slate-800 p-2 text-right text-slate-600 dark:text-slate-300 font-normal">Reference</td>
                              <td class="border border-slate-200 dark:border-slate-800 p-2 text-left text-slate-900 dark:text-white font-medium break-all">{{ tx.reference || (tx.amount > 0 ? 'CREDIT' : 'DEBIT') }}</td>
                            </tr>
                            <tr>
                              <td class="border border-slate-200 dark:border-slate-800 p-2 text-right text-slate-600 dark:text-slate-300 font-normal">Description</td>
                              <td class="border border-slate-200 dark:border-slate-800 p-2 text-left text-slate-900 dark:text-white font-medium break-words">{{ tx.raw_description }}</td>
                            </tr>
                            <tr>
                              <td class="border border-slate-200 dark:border-slate-800 p-2 text-right text-slate-600 dark:text-slate-300 font-normal">Transaction Amount</td>
                              <td class="border border-slate-200 dark:border-slate-800 p-2 text-left text-slate-900 dark:text-white font-medium">{{ number_format(Math.abs(tx.amount), 2) }}</td>
                            </tr>
                            <tr>
                              <td class="border border-slate-200 dark:border-slate-800 p-2 text-right text-slate-600 dark:text-slate-300 font-normal">Transaction Type</td>
                              <td class="border border-slate-200 dark:border-slate-800 p-2 text-left text-slate-900 dark:text-white font-medium">{{ tx.amount < 0 ? 'Debit' : 'Credit' }}</td>
                            </tr>
                            <tr>
                              <td class="border border-slate-200 dark:border-slate-800 p-2 text-right text-slate-600 dark:text-slate-300 font-normal">Cheque No.</td>
                              <td class="border border-slate-200 dark:border-slate-800 p-2 text-left text-slate-900 dark:text-white font-medium">{{ tx.cheque_number || '' }}</td>
                            </tr>
                            <tr>
                              <td class="border border-slate-200 dark:border-slate-800 p-2 text-right text-slate-600 dark:text-slate-300 font-normal">Analysis Code</td>
                              <td class="border border-slate-200 dark:border-slate-800 p-2 text-left text-slate-900 dark:text-white font-medium">{{ tx.analysis_code || '' }}</td>
                            </tr>
                          </tbody>
                        </table>
                      </div>
                  ...
                  <div class="pt-2 border-t border-slate-100 dark:border-slate-800 flex items-end justify-between">
                ...
                <div
                  :class="[
                    'lg:col-span-6 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-lg p-4 shadow-sm flex flex-col justify-between',
                    compactView ? 'min-h-[110px] space-y-1 p-3' : 'min-h-[160px] space-y-3'
                  ]"
                >
                  <div>
                    ...
                    <div class="flex items-center justify-between border-b border-slate-200 dark:border-slate-800 pb-2 mb-3">
                      <div class="flex items-center gap-4 text-xs font-bold">
                        <button
                          ...
                          :class="[
                            ...
                            getRowState(tx.id, tx).tab === 'Match' ? 'text-slate-900 dark:text-white border-b-2 border-[#008ba8]' : 'text-slate-400 hover:text-slate-600 dark:hover:text-slate-300'
                          ]"
                        >
                          Match
                        </button>
                        ...
                        <button
                          ...
                          :class="[
                            'pb-1 cursor-pointer transition-all',
                            getRowState(tx.id, tx).tab === 'Create' ? 'text-slate-900 dark:text-white border-b-2 border-[#008ba8]' : 'text-slate-400 hover:text-slate-600 dark:hover:text-slate-300'
                          ]"
                        >
                          Create
                        </button>
                        ...
                        <button
                          ...
                          :class="[
                            'pb-1 cursor-pointer transition-all',
                            getRowState(tx.id, tx).tab === 'Transfer' ? 'text-slate-900 dark:text-white border-b-2 border-[#008ba8]' : 'text-slate-400 hover:text-slate-600 dark:hover:text-slate-300'
                          ]"
                        >
                          Transfer
                        </button>
                        ...
                        <button
                          ...
                          :class="[
                            'pb-1 cursor-pointer transition-all',
                            getRowState(tx.id, tx).tab === 'Discuss' ? 'text-slate-900 dark:text-white border-b-2 border-[#008ba8]' : 'text-slate-400 hover:text-slate-600 dark:hover:text-slate-300'
                          ]"
                        >
                          Discuss
                        </button>
                      ...
                      <a href="#" @click.prevent="openManualMatchModalForTx(tx)" class="text-xs font-semibold text-blue-600 dark:text-blue-400 hover:underline">Find &amp; Match</a>
                    </div>

                    <!-- Tab Body: CREATE -->
                    <div v-if="getRowState(tx.id, tx).tab === 'Create'" class="space-y-2 text-xs">
                      <div class="grid grid-cols-12 items-center gap-2">
                        <label class="col-span-2 text-right font-semibold text-slate-500 dark:text-slate-400">Who</label>
                        <div class="col-span-10 relative who-dropdown-container">
                          <input
                            ...
                            class="w-full px-2.5 py-1 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded text-xs text-slate-800 dark:text-slate-100 focus:outline-none focus:ring-1 focus:ring-blue-500"
                          />
                          ...
                          <div
                            ...
                            class="absolute left-0 top-full mt-1 w-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg shadow-xl z-30 max-h-48 overflow-y-auto divide-y divide-slate-100 dark:divide-slate-800"
                          >
                            <button
                              ...
                              class="w-full text-left px-3 py-1.5 hover:bg-blue-50 dark:hover:bg-blue-950/40 flex items-center justify-between text-xs transition-colors cursor-pointer"
                            >
                              <div>
                                <span class="font-bold text-slate-900 dark:text-white block text-xs">{{ c.name }}</span>
                                <span class="text-[10px] text-slate-500 dark:text-slate-400 block">{{ c.role || c.kind }}</span>
                              </div>
                              <span class="text-[10px] text-blue-700 dark:text-blue-300 font-mono font-bold bg-blue-50 dark:bg-blue-950/40 px-1.5 py-0.5 rounded border border-blue-100 dark:border-blue-900/40">Select</span>
                            </button>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="grid grid-cols-12 items-center gap-2">
                        <label class="col-span-2 text-right font-semibold text-slate-500 dark:text-slate-400">What</label>
                        <div class="col-span-10">
                          <select
                            v-model="getRowState(tx.id, tx).what"
                            @change="getRowState(tx.id, tx).showWhatError = false"
                            :class="[
                              'w-full px-2.5 py-1 bg-white dark:bg-slate-900 border rounded text-xs text-slate-800 dark:text-slate-100 focus:outline-none focus:ring-1 focus:ring-blue-500',
                              getRowState(tx.id, tx).showWhatError ? 'border-red-500 bg-red-50/50 dark:bg-red-950/50' : 'border-slate-300 dark:border-slate-700'
                            ]"
                          >
                          ...
                          <p v-if="getRowState(tx.id, tx).showWhatError" class="text-[10px] text-red-600 dark:text-red-400 font-bold mt-0.5">Please select an account code (What) before reconciling.</p>
                        </div>
                      </div>

                      <div class="grid grid-cols-12 items-center gap-2">
                        <label class="col-span-2 text-right font-semibold text-slate-500 dark:text-slate-400">Why</label>
                        <div class="col-span-10">
                          <input
                    ...
                    <div v-else-if="getRowState(tx.id, tx).tab === 'Match'" class="space-y-2 text-xs">
                      ...
                      <div v-else class="p-3 text-slate-500 dark:text-slate-400 text-center italic bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-800 rounded">
                    ...
                    <div v-else-if="getRowState(tx.id, tx).tab === 'Transfer'" class="space-y-2 text-xs">
                      <div class="grid grid-cols-12 items-center gap-2">
                        <label class="col-span-3 text-right font-semibold text-slate-500 dark:text-slate-400">Bank Account</label>
                        <div class="col-span-9">
                          <select
                            v-model="getRowState(tx.id, tx).transfer_account"
                            class="w-full px-2.5 py-1 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded text-xs text-slate-800 dark:text-slate-100"
                          >
                    ...
                    <div v-else-if="getRowState(tx.id, tx).tab === 'Discuss'" class="space-y-2 text-xs">
                      <textarea
                        ...
                        rows="2"
                        class="w-full p-2 border border-slate-300 dark:border-slate-700 rounded text-xs focus:ring-1 focus:ring-blue-500"
                      ></textarea>
                    </div>
                  </div>

                  <!-- Bottom Footer Row of Right Card -->
                  <div v-if="getRowState(tx.id, tx).tab === 'Create'" class="pt-2 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between text-xs">
                    <div class="flex items-center gap-2">
                      <select
                        v-model="getRowState(tx.id, tx).category"
                        class="px-2 py-0.5 border border-slate-300 dark:border-slate-700 rounded text-xs text-slate-700 dark:text-slate-200 bg-white dark:bg-slate-900"
                      >
                    ...
                    <a href="#" @click.prevent="openManualMatchModalForTx(tx)" class="text-blue-600 dark:text-blue-400 font-semibold hover:underline">Add details</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <!-- Empty state -->
            <div v-if="filteredUnmatchedTx.length === 0" class="p-12 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl text-center text-slate-400 text-xs italic">
        ...
        <div v-else-if="reconSubTab === 'cash_coding'" class="space-y-4">
          <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-4 shadow-sm flex items-center justify-between gap-4">
            <div>
              <h4 class="font-black text-slate-900 dark:text-white text-sm">Fast Bulk Cash Coding Spreadsheet</h4>
              <p class="text-xs text-slate-500 dark:text-slate-400">Quickly assign payee contacts, nominal account codes, and VAT rates across multiple statement lines simultaneously.</p>
            </div>
            <button
              type="button"
          ...
          <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl shadow-sm overflow-x-auto">
            <table class="w-full text-left text-xs">
              <thead class="bg-slate-100 dark:bg-slate-800 text-[11px] font-black uppercase tracking-wider text-slate-600 dark:text-slate-300 border-b border-slate-200 dark:border-slate-800">
                <tr>
                  <th class="py-2.5 px-3">
                    <input type="checkbox" @change="toggleCashCodingSelectAll" :checked="selectedCashCodingTx.length === filteredUnmatchedTx.length && filteredUnmatchedTx.length > 0" class="rounded text-blue-600 dark:text-blue-400 focus:ring-blue-500" />
                  </th>
              ...
              <tbody class="divide-y divide-slate-200 dark:divide-slate-800 font-medium">
                <tr v-for="tx in filteredUnmatchedTx" :key="tx.id" class="hover:bg-slate-50/80 dark:hover:bg-slate-800/50/80">
                  ...
                  <td class="py-2 px-3 text-slate-500 dark:text-slate-400 font-mono text-[11px] whitespace-nowrap">{{ tx.transaction_date }}</td>
                  <td class="py-2 px-3 relative who-dropdown-container">
                    <input
                      ...
                      data-form-type="other"
                      placeholder="Contact..."
                      class="w-full px-2 py-1 border border-slate-300 dark:border-slate-700 rounded text-xs focus:outline-none focus:ring-1 focus:ring-blue-500"
                    />

                    <!-- Floating Dropdown menu -->
                    <div
                      v-if="getRowState(tx.id, tx).showWhoDropdown && getContactSuggestions(getRowState(tx.id, tx).who).length > 0"
                      class="absolute left-0 top-full mt-1 w-56 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg shadow-xl z-30 max-h-48 overflow-y-auto divide-y divide-slate-100 dark:divide-slate-800"
                    >
                      <button
                        v-for="c in getContactSuggestions(getRowState(tx.id, tx).who)"
                        :key="c.id"
                  ...
                  <td class="py-2 px-3">
                    <input v-model="getRowState(tx.id, tx).why" type="text" placeholder="Description..." class="w-full px-2 py-1 border border-slate-300 dark:border-slate-700 rounded text-xs" />
                  </td>
                  <td class="py-2 px-3">
                    <select
                      v-model="getRowState(tx.id, tx).what"
                  ...
                  <td class="py-2 px-3">
                    <select v-model="getRowState(tx.id, tx).vat" class="w-full px-2 py-1 border border-slate-300 dark:border-slate-700 rounded text-xs">
                      <option value="No VAT">No VAT</option>
                      <option value="20% Standard">20% Standard</option>
                      <option value="Exempt">Exempt</option>
                    </select>
        ...
        <div v-else-if="reconSubTab === 'bank_statements'" class="space-y-4">
          <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-4 shadow-sm flex items-center justify-between gap-4">
            <div class="flex items-center gap-3">
              <span class="text-xs font-bold text-slate-700 dark:text-slate-200">Showing</span>
              <select v-model="statementLinesFilter" class="px-2.5 py-1 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded text-xs font-semibold text-slate-800 dark:text-slate-100">
              ...
              <span v-else class="text-xs font-bold text-blue-700 dark:text-blue-300 bg-blue-50 dark:bg-blue-950/40 px-2 py-0.5 rounded border border-blue-200 dark:border-blue-800/60">
            ...
            <div class="flex items-center gap-2">
              ...
              <button type="button" @click="showImportModal = true" class="px-3.5 py-1.5 bg-slate-900 dark:bg-slate-700 hover:bg-slate-800 dark:hover:bg-slate-600 text-white font-extrabold text-xs rounded-lg shadow cursor-pointer">
                + Upload Statement
              </button>
            </div>
          </div>
          ...
          <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl shadow-sm overflow-x-auto">
            <table class="w-full text-left text-xs border-collapse">
              <thead class="bg-slate-50 dark:bg-slate-800/50 text-[11px] font-bold text-slate-600 dark:text-slate-300 border-b border-slate-200 dark:border-slate-800">
                <tr>
              ...
              <tbody class="divide-y divide-slate-100 dark:divide-slate-800 font-medium">
                <tr v-for="line in filteredStatementLines" :key="line.id" class="hover:bg-slate-50/80 dark:hover:bg-slate-800/50/80 transition-colors">
                  ...
                  <td class="py-2.5 px-3 font-mono text-[11px] text-slate-600 dark:text-slate-300 whitespace-nowrap">{{ line.transaction_date }}</td>
                  <td class="py-2.5 px-3 text-slate-600 dark:text-slate-300 font-medium">{{ line.type }}</td>
                  <td class="py-2.5 px-3 font-bold text-slate-900 dark:text-white">{{ line.raw_description }}</td>
                  <td class="py-2.5 px-3 text-slate-500 dark:text-slate-400 font-mono text-[11px]">{{ line.reference }}</td>
                  <td class="py-2.5 px-3 text-right font-mono font-bold text-slate-900 dark:text-white">{{ line.spent }}</td>
                  <td class="py-2.5 px-3 text-right font-mono font-bold text-emerald-700 dark:text-emerald-300">{{ line.received }}</td>
                  <td class="py-2.5 px-3 text-center text-slate-500 dark:text-slate-400 text-[11px]">{{ line.source }}</td>
                  <td class="py-2.5 px-3 text-center whitespace-nowrap">
                    <span
                      :class="[
                        'px-2.5 py-0.5 text-[10px] font-black rounded-full uppercase tracking-wider',
                        line.status === 'Reconciled' ? 'bg-emerald-100 dark:bg-emerald-900/40 text-emerald-800 dark:text-emerald-200' :
                        line.status === 'Deleted' ? 'bg-rose-100 dark:bg-rose-900/40 text-rose-800 dark:text-rose-200 border border-rose-200 dark:border-rose-800/60' :
        ...
        <div v-else-if="reconSubTab === 'account_transactions'" class="space-y-4">
          <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-4 shadow-sm flex items-center justify-between gap-4">
            <div>
              <h4 class="font-black text-slate-900 dark:text-white text-sm">Internal System Account Transactions History</h4>
              <p class="text-xs text-slate-500 dark:text-slate-400">Internal bookkeeping entries created inside your books (bills, invoices, spend/receive money).</p>
            </div>
            <div class="flex items-center gap-3">
            ...
            <table class="w-full text-left text-xs border-collapse">
              ...
              <tbody class="divide-y divide-slate-100 dark:divide-slate-800 font-medium">
                <tr v-for="tx in filteredAccountTransactions" :key="tx.id" class="hover:bg-slate-50/80 dark:hover:bg-slate-800/50/80 transition-colors">
                  ...
                  <td class="py-2.5 px-3 font-mono text-[11px] text-slate-600 dark:text-slate-300 whitespace-nowrap">{{ tx.transaction_date }}</td>
                  <td class="py-2.5 px-3 text-slate-600 dark:text-slate-300 font-medium">{{ tx.type }}</td>
                  <td class="py-2.5 px-3 font-bold text-slate-900 dark:text-white">{{ tx.description }}</td>
                  <td class="py-2.5 px-3 text-slate-500 dark:text-slate-400 font-mono text-[11px]">{{ tx.reference }}</td>
                  <td class="py-2.5 px-3 text-right font-mono font-bold text-slate-900 dark:text-white">{{ tx.spent }}</td>
                  <td class="py-2.5 px-3 text-right font-mono font-bold text-emerald-700 dark:text-emerald-300">{{ tx.received }}</td>
                  <td class="py-2.5 px-3 text-center whitespace-nowrap">
                    <span
                      :class="[
                        'px-2.5 py-0.5 text-[10px] font-black rounded-full uppercase tracking-wider',
                        tx.status === 'Reconciled' ? 'bg-emerald-100 dark:bg-emerald-900/40 text-emerald-800 dark:text-emerald-200' : 'bg-amber-100 dark:bg-amber-900/40 text-amber-800 dark:text-amber-200'
                      ]"
                    >
                      {{ tx.status }}
                    </span>
        ...
        <div v-else-if="reconSubTab === 'gift_aid'" class="space-y-6">
          <div class="bg-gradient-to-br from-amber-50 dark:from-amber-950/40 to-orange-50 dark:to-orange-950/40 border border-amber-200/80 dark:border-amber-800/80 rounded-2xl p-6 shadow-sm space-y-4">
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div>
                <div class="flex items-center gap-2">
                  <span class="text-xl">🏛️</span>
                  <h4 class="font-black text-slate-900 dark:text-white text-base">Automated Gift Aid Recovery &amp; Relief Chest Reconciliation</h4>
                </div>
                <p class="text-xs text-slate-600 dark:text-slate-300 mt-1">
                  Automatic matching engine for HMRC 25% Gift Aid tax reclaims and MCF Relief Chest (Ref: <span class="font-extrabold text-slate-900 dark:text-white">{{ reconciliation?.gift_aid_summary?.relief_chest_ref || 'E1418' }}</span>) deposit distributions.
                </p>
              </div>
              ...
              <div class="flex flex-wrap items-center gap-2">
                ...
                <a
                  ...
                  target="_blank"
                  class="px-3.5 py-2 bg-white dark:bg-slate-900 hover:bg-slate-50 dark:hover:bg-slate-800/50 border border-slate-200 dark:border-slate-800 text-slate-800 dark:text-slate-100 font-extrabold text-xs rounded-xl shadow-sm transition-all flex items-center gap-1.5"
                >
          ...
          <div class="p-5 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl space-y-3">
            <h5 class="font-extrabold text-slate-900 dark:text-white text-xs uppercase tracking-wider flex items-center gap-1.5">
              <span>💡</span>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs text-slate-600 dark:text-slate-300 leading-relaxed">
              <div class="p-3 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-100 dark:border-slate-800 space-y-1">
                <span class="font-bold text-slate-900 dark:text-white block">1. 25% Tax Reclaim Calculation</span>
              ...
              <div class="p-3 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-100 dark:border-slate-800 space-y-1">
                <span class="font-bold text-slate-900 dark:text-white block">2. Automatic Bank Keyword Matching</span>
                <p class="text-[11px] text-slate-500 dark:text-slate-400">
              ...
              <div class="p-3 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-100 dark:border-slate-800 space-y-1">
                <span class="font-bold text-slate-900 dark:text-white block">3. Double-Entry General Ledger</span>
                <p class="text-[11px] text-slate-500 dark:text-slate-400">
          ...
          <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 shadow-sm space-y-5">
            ...
            <div class="flex flex-col lg:flex-row lg:items-center justify-between pb-4 border-b border-slate-100 dark:border-slate-800 gap-4">
              ...
              <div class="flex flex-wrap items-center gap-2 text-xs">
                <span class="px-3 py-1 bg-blue-50 dark:bg-blue-950/40 text-blue-800 dark:text-blue-200 font-extrabold rounded-xl border border-blue-200/60 dark:border-blue-800/60">
                  Total Filtered Gift Aid: {{ formatCurrency(filteredReconciledGiftAidTotal) }}
                </span>
                <span class="px-3 py-1 bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-200 font-bold rounded-xl border border-slate-200 dark:border-slate-800">
            ...
            <div class="overflow-x-auto rounded-xl border border-slate-200 dark:border-slate-800 shadow-2xs">
              <table class="w-full text-left text-xs border-collapse">
                ...
                <tbody class="divide-y divide-slate-100 dark:divide-slate-800 font-medium text-slate-800 dark:text-slate-100">
                  ...
                  >
                    <!-- Date -->
                    <td class="py-3 px-3.5 font-mono text-[11px] text-slate-600 dark:text-slate-300 whitespace-nowrap">
                      {{ item.created_at }}
                    </td>
                    ...
                    <td class="py-3 px-3.5 whitespace-nowrap">
                      <span class="px-2 py-0.5 rounded-md bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-200 font-bold text-[10px]">
                        {{ item.collection_type }}
                      </span>
                    </td>

                    <!-- Donation Total -->
                    <td class="py-3 px-3.5 text-right font-mono font-bold text-slate-900 dark:text-white whitespace-nowrap">
                      {{ item.formatted_total }}
                    </td>

                    <!-- 25% Gift Aid -->
                    <td class="py-3 px-3.5 text-right font-mono font-extrabold text-blue-700 dark:text-blue-300 whitespace-nowrap">
                    ...
                    <td class="py-3 px-3.5 text-xs text-slate-600 dark:text-slate-300 max-w-xs">
                    ...
                    <!-- Notes -->
                    <td class="py-3 px-3.5 text-slate-500 dark:text-slate-400 text-[11px] max-w-xs truncate" :title="item.notes || 'No notes'">
                      {{ item.notes || '—' }}
                    </td>
                  </tr>
      ...
      <div v-if="activeTab === 'settings'" class="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm p-6 space-y-6">
        <div class="border-b border-slate-100 dark:border-slate-800 pb-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <h3 class="text-lg font-black text-slate-900 dark:text-white">Financial & Accounting Settings</h3>
            <p class="text-xs text-slate-500 dark:text-slate-400">Configure company address, VAT registration numbers, invoicing rules, and billing defaults.</p>
          </div>
          <Link
            :href="route('admin.settings.show', club.slug) + '#accounting'"
            class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-extrabold text-xs rounded-xl shadow-sm transition-all flex items-center gap-1.5 self-start sm:self-auto"
          >
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-xs">
          ...
          <div class="bg-slate-50 dark:bg-slate-800/50 p-5 rounded-2xl border border-slate-200 dark:border-slate-800 space-y-3">
            <div class="flex items-center gap-2">
              ...
              <h4 class="font-extrabold text-slate-900 dark:text-white text-sm">Company & Address</h4>
            </div>
            <div class="space-y-2 text-slate-600 dark:text-slate-300">
              <div>
                <span class="font-bold text-slate-800 dark:text-slate-100 block text-[11px]">Organization Name</span>
                <span class="font-bold text-slate-900 dark:text-white">{{ club.name }}</span>
              </div>
              <div>
          ...
          <div class="bg-slate-50 dark:bg-slate-800/50 p-5 rounded-2xl border border-slate-200 dark:border-slate-800 space-y-3">
            <div class="flex items-center gap-2">
              <span class="text-lg">🧾</span>
              <h4 class="font-extrabold text-slate-900 dark:text-white text-sm">Invoicing & Dues Setup</h4>
            </div>
            <div class="space-y-2 text-slate-600 dark:text-slate-300">
              <div>
                <span class="font-bold text-slate-800 dark:text-slate-100 block text-[11px]">Auto-Invoicing Lead Time</span>
                <span class="font-bold text-slate-900 dark:text-white">{{ settings.auto_invoice_days_before || 7 }} Days before due date</span>
              </div>
              <div>
                <span class="font-bold text-slate-800 dark:text-slate-100 block text-[11px]">Overdue Grace Period</span>
                <span class="font-bold text-amber-800 dark:text-amber-200">{{ settings.dues_grace_period_days || 14 }} Days</span>
              </div>
              <div>
        ...
        <div class="p-4 bg-blue-50 dark:bg-blue-950/40 rounded-2xl border border-blue-200 dark:border-blue-800/60 flex items-center justify-between text-xs">
          <div class="flex items-center gap-3">
            <span class="text-xl">⚙️</span>
            <div>
              <span class="font-black text-blue-900 dark:text-blue-200 block">Edit Organization Settings & Billing Rules</span>
              <span class="text-blue-700 dark:text-blue-300">Update company address, VAT registration number, logos, and role permission matrix.</span>
            </div>
          </div>
          <Link
            :href="route('admin.settings.show', club.slug) + '#accounting'"
            class="px-3.5 py-1.5 bg-blue-700 hover:bg-blue-800 text-white font-bold rounded-xl shadow-sm transition-all whitespace-nowrap"
          >
            Edit Settings →
          </Link>
        </div>
    ...
    <div v-if="showBankAccountModal" class="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/75 backdrop-blur-sm p-4" @click="showBankAccountModal = false">
      <div class="bg-white dark:bg-slate-900 rounded-3xl max-w-lg w-full p-6 shadow-2xl border border-slate-200 dark:border-slate-800 space-y-5" @click.stop>
        <div class="flex items-center justify-between pb-3 border-b border-slate-100 dark:border-slate-800">
          <div class="flex items-center gap-2.5">
            <span class="p-2 bg-blue-50 dark:bg-blue-950/40 text-blue-600 dark:text-blue-400 rounded-xl text-lg">🏦</span>
            <div>
              <h3 class="font-extrabold text-slate-900 dark:text-white text-base">Add Bank / Payment Account</h3>
              <p class="text-[11px] text-slate-500 dark:text-slate-400 font-medium">Create High Street Bank or Manual Account</p>
            </div>
          </div>
          <button type="button" @click="showBankAccountModal = false" class="text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 font-bold text-sm cursor-pointer">✕</button>
        </div>
        ...
        <form @submit.prevent="submitBankAccount" class="space-y-4 text-xs">
          <div>
            ...
            <input v-model="bankAccountForm.bank_name" required placeholder="e.g. Barclays, HSBC, Lloyds, NatWest" class="w-full bg-slate-50 dark:bg-slate-800/50 border border-slate-300 dark:border-slate-700 rounded-xl p-2.5 font-semibold text-slate-900 dark:text-white focus:bg-white dark:focus:bg-slate-900" />
          </div>

          <div>
            <label class="block font-bold text-slate-700 dark:text-slate-200 mb-1">Account Label / Title *</label>
            <input v-model="bankAccountForm.account_name" required placeholder="e.g. Main Operating Account, Online Card Payouts" class="w-full bg-slate-50 dark:bg-slate-800/50 border border-slate-300 dark:border-slate-700 rounded-xl p-2.5 font-semibold text-slate-900 dark:text-white focus:bg-white dark:focus:bg-slate-900" />
          </div>

          <div class="grid grid-cols-2 gap-3">
            <div>
              <label class="block font-bold text-slate-700 dark:text-slate-200 mb-1">Account Type *</label>
              <select v-model="bankAccountForm.account_type" class="w-full bg-slate-50 dark:bg-slate-800/50 border border-slate-300 dark:border-slate-700 rounded-xl p-2.5 font-semibold text-slate-900 dark:text-white focus:bg-white dark:focus:bg-slate-900">
          ...
          <div class="grid grid-cols-2 gap-3">
            <div>
              ...
              <input v-model="bankAccountForm.account_number" placeholder="e.g. 12345678" class="w-full bg-slate-50 dark:bg-slate-800/50 border border-slate-300 dark:border-slate-700 rounded-xl p-2.5 font-semibold text-slate-900 dark:text-white focus:bg-white dark:focus:bg-slate-900" />
            </div>
            <div>
              <label class="block font-bold text-slate-700 dark:text-slate-200 mb-1">Sort Code</label>
              <input v-model="bankAccountForm.sort_code" placeholder="e.g. 20-00-00" class="w-full bg-slate-50 dark:bg-slate-800/50 border border-slate-300 dark:border-slate-700 rounded-xl p-2.5 font-semibold text-slate-900 dark:text-white focus:bg-white dark:focus:bg-slate-900" />
            </div>
          </div>
          ...
          <div v-if="showAccountTypeWarning && detectedMismatch" class="p-3.5 bg-amber-50 dark:bg-amber-950/40 rounded-2xl border border-amber-300 dark:border-amber-700/60 space-y-2.5 animate-in fade-in duration-150">
            <div class="flex items-start gap-2">
              <span class="text-lg leading-none">⚠️</span>
              <div>
                <h4 class="font-extrabold text-amber-900 dark:text-amber-200 text-xs">Recommended Account Type Notice</h4>
                ...
                <p class="text-[10px] text-amber-700 dark:text-amber-300 mt-1 font-medium">{{ detectedMismatch.reason }}</p>
              </div>
            </div>

            <div class="flex flex-col sm:flex-row items-center gap-2 pt-1 border-t border-amber-200/80 dark:border-amber-800/80">
              <button
                type="button"
              ...
              <button
                ...
                class="w-full sm:w-auto px-3 py-2 bg-amber-100 dark:bg-amber-900/40 hover:bg-amber-200 dark:hover:bg-amber-900/60 text-amber-900 dark:text-amber-200 font-bold text-[11px] rounded-xl cursor-pointer transition-all text-center"
              >
                Keep Selection &amp; Save
              </button>
            </div>
          ...
          <div class="flex items-center justify-end gap-3 pt-3 border-t border-slate-100 dark:border-slate-800">
            <button type="button" @click="showBankAccountModal = false" class="px-4 py-2.5 rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 font-bold text-xs cursor-pointer">
              Cancel
            </button>
            <button type="submit" :disabled="bankAccountForm.processing" class="px-5 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-bold text-xs shadow-md shadow-blue-600/20 cursor-pointer">
              Save &amp; Link Account
            </button>
          </div>
        </form>
      ...
      <div class="bg-white dark:bg-slate-900 rounded-3xl max-w-lg w-full p-6 shadow-2xl border border-slate-200 dark:border-slate-800 space-y-5" @click.stop>
        <div class="flex items-center justify-between pb-3 border-b border-slate-100 dark:border-slate-800">
          <div class="flex items-center gap-2.5">
            <span class="p-2 bg-blue-50 dark:bg-blue-950/40 text-blue-600 dark:text-blue-400 rounded-xl text-lg">🟦</span>
            <div>
              <h3 class="font-extrabold text-slate-900 dark:text-white text-base">Connect PayPal Business API</h3>
              <p class="text-[11px] text-slate-500 dark:text-slate-400 font-medium">Automated transaction sync for PayPal sales &amp; payouts</p>
            </div>
          </div>
          <button type="button" @click="showPayPalModal = false" class="text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 font-bold text-sm cursor-pointer">✕</button>
        </div>

        <form @submit.prevent="submitPayPalAccount" class="space-y-4 text-xs">
          <div>
            <label class="block font-bold text-slate-700 dark:text-slate-200 mb-1">Lodge Account Label / Title *</label>
            <input v-model="payPalForm.account_name" required placeholder="e.g. Lodge Operating PayPal Account" class="w-full bg-slate-50 dark:bg-slate-800/50 border border-slate-300 dark:border-slate-700 rounded-xl p-2.5 font-semibold text-slate-900 dark:text-white focus:bg-white dark:focus:bg-slate-900" />
          </div>

          <div>
            <label class="block font-bold text-slate-700 dark:text-slate-200 mb-1">PayPal Client ID *</label>
            <input v-model="payPalForm.paypal_client_id" required placeholder="e.g. A21AA... or Client ID from PayPal Developer Portal" class="w-full bg-slate-50 dark:bg-slate-800/50 border border-slate-300 dark:border-slate-700 rounded-xl p-2.5 font-mono text-slate-900 dark:text-white focus:bg-white dark:focus:bg-slate-900" />
          </div>

          <div>
            <div class="flex items-center justify-between mb-1">
              <label class="font-bold text-slate-700 dark:text-slate-200">PayPal Client Secret *</label>
              <button type="button" @click="showPayPalSecret = !showPayPalSecret" class="text-[10px] font-bold text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-200 cursor-pointer">
                {{ showPayPalSecret ? 'Hide' : 'Show Secret' }}
              </button>
            </div>
            <input :type="showPayPalSecret ? 'text' : 'password'" v-model="payPalForm.paypal_client_secret" required placeholder="PayPal API Secret Key" class="w-full bg-slate-50 dark:bg-slate-800/50 border border-slate-300 dark:border-slate-700 rounded-xl p-2.5 font-mono text-slate-900 dark:text-white focus:bg-white dark:focus:bg-slate-900" />
          </div>

          <div class="grid grid-cols-2 gap-3">
            <div>
              <label class="block font-bold text-slate-700 dark:text-slate-200 mb-1">Environment *</label>
              <select v-model="payPalForm.paypal_environment" class="w-full bg-slate-50 dark:bg-slate-800/50 border border-slate-300 dark:border-slate-700 rounded-xl p-2.5 font-semibold text-slate-900 dark:text-white focus:bg-white dark:focus:bg-slate-900">
          ...
          <div class="p-3 bg-blue-50/90 dark:bg-blue-950/90 rounded-2xl border border-blue-200 dark:border-blue-800/60 text-blue-900 dark:text-blue-200 text-[11px] space-y-1">
          ...
          <div class="flex items-center justify-end gap-3 pt-3 border-t border-slate-100 dark:border-slate-800">
            <button type="button" @click="showPayPalModal = false" class="px-4 py-2.5 rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 font-bold text-xs cursor-pointer">
              Cancel
            </button>
      ...
      <div class="bg-white dark:bg-slate-900 rounded-3xl max-w-lg w-full p-6 shadow-2xl border border-slate-200 dark:border-slate-800 space-y-5" @click.stop>
        <div class="flex items-center justify-between pb-3 border-b border-slate-100 dark:border-slate-800">
          <div class="flex items-center gap-2.5">
            <span class="p-2 bg-blue-50 dark:bg-blue-950/40 text-blue-600 dark:text-blue-400 rounded-xl text-lg">💜</span>
            <div>
              <h3 class="font-extrabold text-slate-900 dark:text-white text-base">Connect Stripe API</h3>
              <p class="text-[11px] text-slate-500 dark:text-slate-400 font-medium">Automated balance transactions &amp; payout feed sync</p>
            </div>
          </div>
          <button type="button" @click="showStripeModal = false" class="text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 font-bold text-sm cursor-pointer">✕</button>
        </div>

        <form @submit.prevent="submitStripeAccount" class="space-y-4 text-xs">
          <div>
            <label class="block font-bold text-slate-700 dark:text-slate-200 mb-1">Lodge Account Label / Title *</label>
            <input v-model="stripeForm.account_name" required placeholder="e.g. Lodge Stripe Account" class="w-full bg-slate-50 dark:bg-slate-800/50 border border-slate-300 dark:border-slate-700 rounded-xl p-2.5 font-semibold text-slate-900 dark:text-white focus:bg-white dark:focus:bg-slate-900" />
          </div>

          <div>
            <div class="flex items-center justify-between mb-1">
              <label class="font-bold text-slate-700 dark:text-slate-200">Stripe Secret Key *</label>
              <button type="button" @click="showStripeSecret = !showStripeSecret" class="text-[10px] font-bold text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-200 cursor-pointer">
                {{ showStripeSecret ? 'Hide' : 'Show Key' }}
              </button>
            </div>
            <input :type="showStripeSecret ? 'text' : 'password'" v-model="stripeForm.stripe_secret_key" required placeholder="sk_live_... or sk_test_..." class="w-full bg-slate-50 dark:bg-slate-800/50 border border-slate-300 dark:border-slate-700 rounded-xl p-2.5 font-mono text-slate-900 dark:text-white focus:bg-white dark:focus:bg-slate-900" />
          </div>
          ...
          <div class="flex items-center justify-end gap-3 pt-3 border-t border-slate-100 dark:border-slate-800">
            <button type="button" @click="showStripeModal = false" class="px-4 py-2.5 rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 font-bold text-xs cursor-pointer">
              Cancel
            </button>
            <button type="submit" :disabled="stripeForm.processing" class="px-5 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-bold text-xs shadow-md shadow-blue-600/20 cursor-pointer">
              Save &amp; Connect Stripe
            </button>
          </div>
        </form>
      ...
      <div class="bg-white dark:bg-slate-900 rounded-3xl max-w-lg w-full p-6 shadow-2xl border border-slate-200 dark:border-slate-800 space-y-5" @click.stop>
        <div class="flex items-center justify-between pb-3 border-b border-slate-100 dark:border-slate-800">
          <div class="flex items-center gap-2.5">
            ...
            <div>
              <h3 class="font-extrabold text-slate-900 dark:text-white text-base">Connect SumUp Card Reader API</h3>
              <p class="text-[11px] text-slate-500 dark:text-slate-400 font-medium">Automated card terminal sales &amp; payout feed sync</p>
            </div>
          </div>
          <button type="button" @click="showSumUpModal = false" class="text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 font-bold text-sm cursor-pointer">✕</button>
        </div>

        <form @submit.prevent="submitSumUpAccount" class="space-y-4 text-xs">
          <div>
            <label class="block font-bold text-slate-700 dark:text-slate-200 mb-1">Lodge Account Label / Title *</label>
            <input v-model="sumUpForm.account_name" required placeholder="e.g. Lodge SumUp Merchant Account" class="w-full bg-slate-50 dark:bg-slate-800/50 border border-slate-300 dark:border-slate-700 rounded-xl p-2.5 font-semibold text-slate-900 dark:text-white focus:bg-white dark:focus:bg-slate-900" />
          </div>

          <div>
            <div class="flex items-center justify-between mb-1">
              <label class="font-bold text-slate-700 dark:text-slate-200">SumUp API Access Token / Key *</label>
              <button type="button" @click="showSumUpKey = !showSumUpKey" class="text-[10px] font-bold text-emerald-600 dark:text-emerald-400 hover:text-emerald-800 dark:hover:text-emerald-200 cursor-pointer">
                {{ showSumUpKey ? 'Hide' : 'Show Key' }}
              </button>
            </div>
            <input :type="showSumUpKey ? 'text' : 'password'" v-model="sumUpForm.sumup_api_key" required placeholder="sup_sk_... or SumUp API Key" class="w-full bg-slate-50 dark:bg-slate-800/50 border border-slate-300 dark:border-slate-700 rounded-xl p-2.5 font-mono text-slate-900 dark:text-white focus:bg-white dark:focus:bg-slate-900" />
          </div>
          ...
          <div class="p-3 bg-emerald-50/90 dark:bg-emerald-950/90 rounded-2xl border border-emerald-200 dark:border-emerald-800/60 text-emerald-900 dark:text-emerald-200 text-[11px] space-y-1">
          ...
          <div class="flex items-center justify-end gap-3 pt-3 border-t border-slate-100 dark:border-slate-800">
            <button type="button" @click="showSumUpModal = false" class="px-4 py-2.5 rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 font-bold text-xs cursor-pointer">
              Cancel
            </button>
      ...
      <div class="bg-white dark:bg-slate-900 rounded-3xl max-w-lg w-full p-6 shadow-2xl border border-slate-200 dark:border-slate-800 space-y-5" @click.stop>
        <div class="flex items-center justify-between pb-3 border-b border-slate-100 dark:border-slate-800">
          <div class="flex items-center gap-2.5">
            ...
            <div>
              <h3 class="font-extrabold text-slate-900 dark:text-white text-base">Connect GoCardless Direct Debit API</h3>
              <p class="text-[11px] text-slate-500 dark:text-slate-400 font-medium">Automated UK Direct Debit mandate collection &amp; transaction feed</p>
            </div>
          </div>
          <button type="button" @click="showGoCardlessModal = false" class="text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 font-bold text-sm cursor-pointer">✕</button>
        </div>

        <form @submit.prevent="submitGoCardlessAccount" class="space-y-4 text-xs">
          <div>
            <label class="block font-bold text-slate-700 dark:text-slate-200 mb-1">Account Label / Title *</label>
            <input v-model="goCardlessForm.account_name" required placeholder="e.g. Lodge GoCardless Direct Debit Account" class="w-full bg-slate-50 dark:bg-slate-800/50 border border-slate-300 dark:border-slate-700 rounded-xl p-2.5 font-semibold text-slate-900 dark:text-white focus:bg-white dark:focus:bg-slate-900" />
          </div>
          ...
          <div>
            ...
            <div class="grid grid-cols-2 gap-3">
              <button
                ...
                :class="['p-2.5 rounded-xl border text-center font-bold text-xs cursor-pointer transition-all', goCardlessForm.gocardless_environment === 'sandbox' ? 'bg-amber-50 dark:bg-amber-950/40 border-amber-400 text-amber-900 dark:text-amber-200 shadow-sm' : 'bg-slate-50 dark:bg-slate-800/50 border-slate-200 dark:border-slate-800 text-slate-600 dark:text-slate-300']"
              >
                🧪 Sandbox (Testing)
              </button>
              <button
                ...
                :class="['p-2.5 rounded-xl border text-center font-bold text-xs cursor-pointer transition-all', goCardlessForm.gocardless_environment === 'live' ? 'bg-emerald-50 dark:bg-emerald-950/40 border-emerald-400 text-emerald-900 dark:text-emerald-200 shadow-sm' : 'bg-slate-50 dark:bg-slate-800/50 border-slate-200 dark:border-slate-800 text-slate-600 dark:text-slate-300']"
              >
                ⚡ Live Production
              </button>
            </div>
          ...
          <div>
            <div class="flex items-center justify-between mb-1">
              <label class="font-bold text-slate-700 dark:text-slate-200">GoCardless Access Token *</label>
              <button type="button" @click="showGoCardlessToken = !showGoCardlessToken" class="text-[10px] font-bold text-amber-600 dark:text-amber-400 hover:text-amber-800 dark:hover:text-amber-200 cursor-pointer">
                {{ showGoCardlessToken ? 'Hide' : 'Show Token' }}
              </button>
            </div>
            <input :type="showGoCardlessToken ? 'text' : 'password'" v-model="goCardlessForm.gocardless_access_token" required placeholder="live_... or sandbox_..." class="w-full bg-slate-50 dark:bg-slate-800/50 border border-slate-300 dark:border-slate-700 rounded-xl p-2.5 font-mono text-slate-900 dark:text-white focus:bg-white dark:focus:bg-slate-900" />
          </div>

          <div>
            <div class="flex items-center justify-between mb-1">
              <label class="font-bold text-slate-700 dark:text-slate-200">Webhook Secret (Optional)</label>
              <button type="button" @click="showGoCardlessSecret = !showGoCardlessSecret" class="text-[10px] font-bold text-amber-600 dark:text-amber-400 hover:text-amber-800 dark:hover:text-amber-200 cursor-pointer">
                {{ showGoCardlessSecret ? 'Hide' : 'Show Secret' }}
              </button>
            </div>
            <input :type="showGoCardlessSecret ? 'text' : 'password'" v-model="goCardlessForm.gocardless_webhook_secret" placeholder="GoCardless Webhook Secret Key" class="w-full bg-slate-50 dark:bg-slate-800/50 border border-slate-300 dark:border-slate-700 rounded-xl p-2.5 font-mono text-slate-900 dark:text-white focus:bg-white dark:focus:bg-slate-900" />
          </div>
          ...
          <div class="p-3 bg-amber-50/90 dark:bg-amber-950/90 rounded-2xl border border-amber-200 dark:border-amber-800/60 text-amber-900 dark:text-amber-200 text-[11px] space-y-1">
          ...
          <div class="flex items-center justify-end gap-3 pt-3 border-t border-slate-100 dark:border-slate-800">
            <button type="button" @click="showGoCardlessModal = false" class="px-4 py-2.5 rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 font-bold text-xs cursor-pointer">
              Cancel
            </button>
    ...
    <div v-if="showGatewaySyncModal" class="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/75 backdrop-blur-sm p-4" @click="showGatewaySyncModal = false">
      <div class="bg-white dark:bg-slate-900 rounded-3xl max-w-md w-full p-6 shadow-2xl border border-slate-200 dark:border-slate-800 space-y-5" @click.stop>
        <div class="flex items-center justify-between pb-3 border-b border-slate-100 dark:border-slate-800">
          <div class="flex items-center gap-2.5">
            <span v-if="gatewaySyncType === 'stripe'" class="p-2 bg-blue-50 dark:bg-blue-950/40 text-blue-600 dark:text-blue-400 rounded-xl text-lg">⚡</span>
            <span v-else-if="gatewaySyncType === 'sumup'" class="p-2 bg-emerald-50 dark:bg-emerald-950/40 text-emerald-600 dark:text-emerald-400 rounded-xl text-lg">⚡</span>
            <span v-else class="p-2 bg-blue-50 dark:bg-blue-950/40 text-blue-600 dark:text-blue-400 rounded-xl text-lg">⚡</span>
            <div>
              ...
              <p class="text-[11px] text-slate-500 dark:text-slate-400 font-medium">Select custom date range to pull settled transactions</p>
            </div>
          </div>
          <button type="button" @click="showGatewaySyncModal = false" class="text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 font-bold text-sm cursor-pointer">✕</button>
        </div>
        ...
        <form @submit.prevent="submitGatewaySyncModal" class="space-y-4 text-xs">
          ...
          <div class="grid grid-cols-2 gap-3">
            <div>
              <label class="block font-bold text-slate-700 dark:text-slate-200 mb-1">From Date (Start) *</label>
              <input type="date" v-model="gatewaySyncForm.start_date" required class="w-full bg-slate-50 dark:bg-slate-800/50 border border-slate-300 dark:border-slate-700 rounded-xl p-2.5 font-semibold text-slate-900 dark:text-white focus:bg-white dark:focus:bg-slate-900" />
            </div>

            <div>
              <label class="block font-bold text-slate-700 dark:text-slate-200 mb-1">To Date (End) *</label>
              <input type="date" v-model="gatewaySyncForm.end_date" required class="w-full bg-slate-50 dark:bg-slate-800/50 border border-slate-300 dark:border-slate-700 rounded-xl p-2.5 font-semibold text-slate-900 dark:text-white focus:bg-white dark:focus:bg-slate-900" />
            </div>
          </div>

          <div class="flex items-center justify-end gap-3 pt-3 border-t border-slate-100 dark:border-slate-800">
            <button type="button" @click="showGatewaySyncModal = false" class="px-4 py-2.5 rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 font-bold text-xs cursor-pointer">
              Cancel
            </button>
            <button
              type="submit"
              ...
              :class="[
                ...
                gatewaySyncType === 'stripe' ? 'bg-blue-600 hover:bg-blue-700 shadow-blue-600/20' : (gatewaySyncType === 'sumup' ? 'bg-emerald-600 hover:bg-emerald-700 shadow-emerald-600/20' : 'bg-blue-600 hover:bg-blue-700 shadow-blue-600/20')
              ]"
            >
    ...
    <div v-if="showAccountModal" class="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/75 backdrop-blur-sm p-4" @click="showAccountModal = false">
      <div class="bg-white dark:bg-slate-900 rounded-3xl max-w-md w-full p-6 shadow-2xl border border-slate-200 dark:border-slate-800 space-y-5" @click.stop>
        <div class="flex items-center justify-between pb-3 border-b border-slate-100 dark:border-slate-800">
          <h3 class="text-base font-black text-slate-900 dark:text-white">Add Account to Ledger</h3>
          <button type="button" @click="showAccountModal = false" class="text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 font-bold text-sm">✕</button>
        </div>

        <form @submit.prevent="submitAccount" class="space-y-4 text-xs">
          <div class="space-y-1">
            <label class="block font-bold text-slate-700 dark:text-slate-200">Account Code (Numeric)</label>
            <input
              v-model="accountForm.code"
              type="text"
              placeholder="e.g. 1300"
              class="w-full px-3 py-2 border border-slate-200 dark:border-slate-800 rounded-xl font-mono text-xs focus:outline-none focus:border-blue-500"
              required
            />
          </div>

          <div class="space-y-1">
            <label class="block font-bold text-slate-700 dark:text-slate-200">Account Title / Name</label>
            <input
              v-model="accountForm.name"
              type="text"
              placeholder="e.g. Equipment Reserve"
              class="w-full px-3 py-2 border border-slate-200 dark:border-slate-800 rounded-xl text-xs focus:outline-none focus:border-blue-500"
              required
            />
          </div>

          <div class="space-y-1">
            <label class="block font-bold text-slate-700 dark:text-slate-200">Account Category Type</label>
            <select
              v-model="accountForm.type"
              class="w-full px-3 py-2 border border-slate-200 dark:border-slate-800 rounded-xl text-xs font-bold focus:outline-none focus:border-blue-500"
            >
          ...
          <div class="grid grid-cols-2 gap-3 pt-2 border-t border-slate-100 dark:border-slate-800">
            ...
            <div class="space-y-1">
              <label class="block font-bold text-slate-700 dark:text-slate-200">As of Date</label>
              <input
          ...
          <div class="pt-2 flex items-center justify-end gap-2">
            <button
              ...
              class="px-4 py-2 bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-200 font-bold rounded-xl text-xs"
            >
              Cancel
            </button>
            <button
              ...
              class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl text-xs shadow-sm"
            >
              Save Account
            </button>
          </div>
    ...
    <div v-if="showJournalModal" class="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/75 backdrop-blur-sm p-4 overflow-y-auto" @click="showJournalModal = false">
      <div class="bg-white dark:bg-slate-900 rounded-3xl max-w-3xl w-full p-6 shadow-2xl border border-slate-200 dark:border-slate-800 space-y-5" @click.stop>
        <div class="flex items-center justify-between pb-3 border-b border-slate-100 dark:border-slate-800">
          <div>
            <h3 class="text-base font-black text-slate-900 dark:text-white">Add Journal Entry (Manual Ledger Adjustment)</h3>
            <p class="text-xs text-slate-500 dark:text-slate-400">Record a manual double-entry ledger adjustment. (To add a vendor bill, click "+ Add Bill" above).</p>
          </div>
          <button type="button" @click="showJournalModal = false" class="text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 font-bold text-sm">✕</button>
        </div>

        <form @submit.prevent="submitJournal" class="space-y-4 text-xs">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="space-y-1">
              <label class="block font-bold text-slate-700 dark:text-slate-200">Transaction Description</label>
              <input
            ...
            <div class="space-y-1">
              <label class="block font-bold text-slate-700 dark:text-slate-200">Posting Date</label>
              <input
          ...
          <div class="space-y-2 pt-2 border-t border-slate-100 dark:border-slate-800">
            <div class="flex items-center justify-between">
              <span class="font-extrabold text-slate-800 dark:text-slate-100">Ledger Line Items</span>
              <button
                type="button"
                @click="addJournalLine"
                class="text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 font-bold text-xs"
              >
                + Add Row
              </button>
            </div>

            <div v-for="(item, idx) in journalForm.items" :key="idx" class="grid grid-cols-12 gap-2 items-center bg-slate-50 dark:bg-slate-800/50 p-2.5 rounded-xl border border-slate-200 dark:border-slate-800">
              <div class="col-span-5">
                <select
                  v-model="item.account_id"
                  class="w-full px-2 py-1.5 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg text-xs font-semibold focus:outline-none"
                  required
                >
              ...
              <div class="col-span-1 text-center">
                <button
                  ...
                  class="text-slate-400 hover:text-rose-600 dark:hover:text-rose-400 font-bold"
                  title="Remove row"
                >
                  ✕
                </button>
          ...
          <div class="p-3 rounded-xl border flex items-center justify-between" :class="isJournalBalanced ? 'bg-emerald-50 dark:bg-emerald-950/40 border-emerald-200 dark:border-emerald-800/60 text-emerald-900 dark:text-emerald-200' : 'bg-rose-50 dark:bg-rose-950/40 border-rose-200 dark:border-rose-800/60 text-rose-900 dark:text-rose-200'">
          ...
          <div class="pt-2 flex items-center justify-end gap-2">
            ...
            <button
              ...
              class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl text-xs shadow-sm disabled:opacity-50 cursor-pointer"
            >
              Post Journal Entry
            </button>
          </div>
    ...
    <div v-if="showInvoiceModal" class="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/75 backdrop-blur-sm p-4" @click="showInvoiceModal = false">
      <div class="bg-white dark:bg-slate-900 rounded-3xl max-w-md w-full p-6 shadow-2xl border border-slate-200 dark:border-slate-800 space-y-5" @click.stop>
        <div class="flex items-center justify-between pb-3 border-b border-slate-100 dark:border-slate-800">
          <h3 class="text-base font-black text-slate-900 dark:text-white">Create Member Invoice</h3>
          <button type="button" @click="showInvoiceModal = false" class="text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 font-bold text-sm">✕</button>
        </div>

        <form @submit.prevent="submitInvoice" class="space-y-4 text-xs">
          <div class="space-y-1">
            <label class="block font-bold text-slate-700 dark:text-slate-200">Select Member</label>
            <select
              v-model="invoiceForm.user_id"
              class="w-full px-3 py-2 border border-slate-200 dark:border-slate-800 rounded-xl text-xs font-semibold focus:outline-none focus:border-blue-500"
              required
            >
          ...
          <div class="space-y-1">
            <label class="block font-bold text-slate-700 dark:text-slate-200">Invoice Title / Description</label>
            <input
          ...
          <div class="pt-2 flex items-center justify-between gap-2">
            ...
            <div class="flex items-center gap-2">
              <button
                ...
                class="px-3.5 py-2 bg-slate-200 dark:bg-slate-700 hover:bg-slate-300 text-slate-800 dark:text-slate-100 font-extrabold rounded-xl text-xs transition-colors cursor-pointer"
              >
                📝 Save Draft
              </button>
              <button
    ...
    <div v-if="showBillModal" class="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/75 backdrop-blur-sm p-4" @click="showBillModal = false">
      <div class="bg-white dark:bg-slate-900 rounded-3xl max-w-md w-full p-6 shadow-2xl border border-slate-200 dark:border-slate-800 space-y-5" @click.stop>
        <div class="flex items-center justify-between pb-3 border-b border-slate-100 dark:border-slate-800">
          <h3 class="text-base font-black text-slate-900 dark:text-white">Add Vendor Bill (A/P)</h3>
          <button type="button" @click="showBillModal = false" class="text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 font-bold text-sm">✕</button>
        </div>

        <form @submit.prevent="submitBill" class="space-y-4 text-xs">
          <div class="space-y-1">
            <label class="block font-bold text-slate-700 dark:text-slate-200">Vendor Name</label>
            <input
          ...
          <div class="space-y-1">
            <label class="block font-bold text-slate-700 dark:text-slate-200">Expense Category</label>
            <input
          ...
          <div class="grid grid-cols-2 gap-3">
            ...
            <div class="space-y-1">
              <label class="block font-bold text-slate-700 dark:text-slate-200">Due Date</label>
              <input
          ...
          <div class="space-y-1">
            <label class="block font-bold text-slate-700 dark:text-slate-200">Notes / Reference</label>
            <textarea
              v-model="billForm.notes"
              rows="2"
              placeholder="Optional notes or PO number..."
              class="w-full px-3 py-2 border border-slate-200 dark:border-slate-800 rounded-xl text-xs focus:outline-none focus:border-blue-500 resize-none"
            ></textarea>
          </div>

          <div class="space-y-1">
            <label class="block font-bold text-slate-700 dark:text-slate-200">Receipt / Invoice File (PDF, PNG, JPG, WEBP)</label>
            <input
              type="file"
              accept=".pdf,.png,.jpg,.jpeg,.webp"
              @change="handleBillFileChange"
              class="w-full text-xs text-slate-600 dark:text-slate-300 file:mr-3 file:py-1.5 file:px-3 file:rounded-lg file:border-0 file:text-xs file:font-bold file:bg-slate-100 dark:file:bg-slate-800 file:text-slate-700 dark:file:text-slate-200 hover:file:bg-slate-200 dark:hover:file:bg-slate-700 cursor-pointer"
            />
            <p v-if="billForm.errors.attachment" class="text-[11px] text-red-600 dark:text-red-400 font-semibold mt-0.5">{{ billForm.errors.attachment }}</p>
            <p v-if="billForm.attachment" class="text-[10px] text-emerald-600 dark:text-emerald-400 font-bold mt-0.5">
    ...
    <div v-if="showOpeningBalanceModal" class="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/75 backdrop-blur-sm p-4" @click="showOpeningBalanceModal = false">
      <div class="bg-white dark:bg-slate-900 rounded-3xl max-w-md w-full p-6 shadow-2xl border border-slate-200 dark:border-slate-800 space-y-5" @click.stop>
        <div class="flex items-center justify-between pb-3 border-b border-slate-100 dark:border-slate-800">
          <div>
            <h3 class="text-base font-black text-slate-900 dark:text-white">Set Account Opening / Carry Over Balance</h3>
            <p class="text-xs text-slate-500 dark:text-slate-400">Record initial carry-over funds when setting up your club accounts for the first time.</p>
          </div>
          <button type="button" @click="showOpeningBalanceModal = false" class="text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 font-bold text-sm">✕</button>
        </div>

        <form @submit.prevent="submitOpeningBalance" class="space-y-4 text-xs">
          <div class="space-y-1">
            <label class="block font-bold text-slate-700 dark:text-slate-200">Target Ledger Account *</label>
            <select
          ...
          <div class="grid grid-cols-2 gap-3">
            ...
            <div class="space-y-1">
              <label class="block font-bold text-slate-700 dark:text-slate-200">Effective Date *</label>
              <input
          ...
          <div class="pt-2 flex items-center justify-end gap-2">
            <button
              ...
              class="px-4 py-2 bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-200 font-bold rounded-xl text-xs cursor-pointer"
            >
              Cancel
            </button>
            <button
    ...
    <div v-if="showImportModal" class="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/75 backdrop-blur-sm p-4" @click="showImportModal = false">
      <div class="bg-white dark:bg-slate-900 rounded-3xl max-w-md w-full p-6 shadow-2xl border border-slate-200 dark:border-slate-800 space-y-5" @click.stop>
        <div class="flex items-center justify-between pb-3 border-b border-slate-100 dark:border-slate-800">
          <div>
            <h3 class="text-base font-black text-slate-900 dark:text-white">Import Bank Statement</h3>
            <p class="text-xs text-slate-500 dark:text-slate-400">Upload UK CSV or OFX bank export for automated matcher staging.</p>
          </div>
          <button type="button" @click="showImportModal = false" class="text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 font-bold text-sm">✕</button>
        </div>

        <form @submit.prevent="submitStatementImport" class="space-y-4 text-xs">
          <div class="space-y-1">
            <label class="block font-bold text-slate-700 dark:text-slate-200">Bank Statement File (CSV/OFX) *</label>
            <input
              type="file"
          ...
          <div class="p-3 bg-blue-50 dark:bg-blue-950/40 rounded-xl border border-blue-200 dark:border-blue-800/60 text-blue-900 dark:text-blue-200 text-[11px] space-y-1">
    ...
    <div v-if="showManualModal" class="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/75 backdrop-blur-sm p-4" @click="showManualModal = false">
      <div class="bg-white dark:bg-slate-900 rounded-3xl max-w-lg w-full p-6 shadow-2xl border border-slate-200 dark:border-slate-800 space-y-5" @click.stop>
        <div class="flex items-center justify-between pb-3 border-b border-slate-100 dark:border-slate-800">
          <div>
            <h3 class="text-base font-black text-slate-900 dark:text-white">Manual Target Allocation</h3>
            <p class="text-xs text-slate-500 dark:text-slate-400">Nominate custom allocation for statement line: <span class="font-bold text-slate-900 dark:text-white">{{ selectedTx?.raw_description }}</span></p>
          </div>
          <button type="button" @click="showManualModal = false" class="text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 font-bold text-sm">✕</button>
        </div>

        <div class="space-y-4 text-xs">
          <div class="space-y-1">
            <label class="block font-bold text-slate-700 dark:text-slate-200">Allocation Destination Type</label>
            <select
              v-model="manualMatchType"
              class="w-full px-3 py-2 border border-slate-200 dark:border-slate-800 rounded-xl font-bold focus:outline-none focus:border-blue-500"
            >
          ...
          <div v-if="manualMatchType === 'member_subscription'" class="space-y-1">
            <label class="block font-bold text-slate-700 dark:text-slate-200">Select Unpaid Subscription *</label>
            <select
          ...
          <div v-if="manualMatchType === 'supplier_bill'" class="space-y-1">
            <label class="block font-bold text-slate-700 dark:text-slate-200">Select Unpaid Supplier Bill *</label>
            <select
              v-model="manualTargetId"
              class="w-full px-3 py-2 border border-slate-200 dark:border-slate-800 rounded-xl font-bold focus:outline-none focus:border-blue-500"
            >
          ...
          <div v-if="manualMatchType === 'ledger_account'" class="space-y-1">
            <label class="block font-bold text-slate-700 dark:text-slate-200">Select Ledger Account Code *</label>
            <select
          ...
          <div class="pt-2 flex items-center justify-end gap-2">
            ...
            <button
              ...
              class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl text-xs shadow-sm cursor-pointer"
            >
    ...
    >
      <div
        class="bg-white dark:bg-slate-900 rounded-3xl max-w-lg w-full p-6 shadow-2xl border border-slate-200 dark:border-slate-800 space-y-5"
        @click.stop
      >
        <div class="flex items-center justify-between pb-3 border-b border-slate-100 dark:border-slate-800">
          <div>
            <h3 class="text-base font-black text-slate-900 dark:text-white">Bank Statement Line Details</h3>
            <p class="text-xs text-slate-500 dark:text-slate-400">Full metadata imported from bank statement feed.</p>
          </div>
          <button
            type="button"
            @click="showStatementLineDetailsModal = false"
            class="text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 font-bold text-sm cursor-pointer"
          >
            ✕
          </button>
        </div>
        ...
        <div class="space-y-3 text-xs">
          <div class="grid grid-cols-2 gap-3 bg-slate-50 dark:bg-slate-800/50 p-3.5 rounded-2xl border border-slate-200 dark:border-slate-800">
            <div>
              <span class="text-[10px] font-extrabold uppercase text-slate-400 block mb-0.5">Transaction Date</span>
              <span class="font-bold text-slate-900 dark:text-white text-sm">{{ selectedStatementLineDetails.transaction_date }}</span>
            </div>
            <div>
          ...
          <div class="space-y-1">
            ...
            <div class="bg-white dark:bg-slate-900 p-3 rounded-xl border border-slate-200 dark:border-slate-800 font-extrabold text-slate-900 dark:text-white text-sm leading-snug">
          ...
          <div class="grid grid-cols-2 gap-3 pt-1">
            <div>
              ...
              <span
                :class="[
                  ...
                  selectedStatementLineDetails.status === 'Reconciled' ? 'bg-emerald-100 dark:bg-emerald-900/40 text-emerald-800 dark:text-emerald-200' :
                  selectedStatementLineDetails.status === 'Deleted' ? 'bg-rose-100 dark:bg-rose-900/40 text-rose-800 dark:text-rose-200' :
                  'bg-amber-100 dark:bg-amber-900/40 text-amber-800 dark:text-amber-200'
                ]"
              >
            ...
            <div>
              ...
              <span class="font-mono text-slate-500 dark:text-slate-400 font-bold text-xs">#{{ selectedStatementLineDetails.id }}</span>
            </div>
          </div>
        </div>
        ...
        <div class="pt-3 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between">
          <button
            ...
            class="px-3.5 py-2 bg-rose-50 dark:bg-rose-950/40 hover:bg-rose-100 dark:hover:bg-rose-900/40 text-rose-700 dark:text-rose-300 font-bold text-xs rounded-xl transition-all cursor-pointer flex items-center gap-1.5"
          >
            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
            </svg>
          ...
          <button
            type="button"
            @click="showStatementLineDetailsModal = false"
            class="px-4 py-2 bg-slate-900 dark:bg-slate-700 hover:bg-slate-800 dark:hover:bg-slate-600 text-white font-bold text-xs rounded-xl shadow-sm cursor-pointer"
          >
            Close
          </button>
        </div>
      ...
      >
        <div class="flex items-center justify-between pb-3 border-b border-slate-100 dark:border-slate-800">
          <div class="flex items-center gap-2">
            <span class="text-xl">⚖️</span>
            <div>
              <h3 class="text-base font-black text-slate-900 dark:text-white">Why do your balances differ?</h3>
              <p class="text-xs text-slate-500 dark:text-slate-400">Bank Statement Balance vs System Ledger Balance</p>
            </div>
          </div>
          <button type="button" @click="showDifferentBalancesModal = false" class="text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 font-bold text-sm">✕</button>
        </div>
        ...
        <div class="space-y-4 text-xs">
          ...
          <div class="p-3 bg-amber-50 dark:bg-amber-950/40 rounded-xl border border-amber-200 dark:border-amber-800/60 text-amber-900 dark:text-amber-200 text-[11px] space-y-1">
            <span class="font-bold block">💡 Common causes of balance variance:</span>
            <ul class="list-disc list-inside space-y-0.5 text-amber-800 dark:text-amber-200">
      ...
      >
        <div class="flex items-center justify-between pb-3 border-b border-slate-100 dark:border-slate-800">
          <div class="flex items-center gap-2">
            ...
            <div>
              <h3 class="text-base font-black text-slate-900 dark:text-white">Understanding Bank Balances</h3>
              <p class="text-xs text-slate-500 dark:text-slate-400">Statement Balance vs Balance in System</p>
            </div>
          </div>
          <button type="button" @click="showWhatsThisModal = false" class="text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 font-bold text-sm">✕</button>
        </div>

        <div class="space-y-4 text-xs text-slate-600 dark:text-slate-300 leading-relaxed">
          <div class="p-3 bg-blue-50 dark:bg-blue-950/40 rounded-2xl border border-blue-200 dark:border-blue-800/60 space-y-1">
            <span class="font-extrabold text-blue-900 dark:text-blue-200 block text-xs">🏦 Statement Balance</span>
            <p class="text-blue-800 dark:text-blue-200 text-[11px]">
          ...
          <div class="p-3 bg-blue-50 dark:bg-blue-950/40 rounded-2xl border border-blue-200 dark:border-blue-800/60 space-y-1">
            <span class="font-extrabold text-blue-900 dark:text-blue-200 block text-xs">📖 Balance in System</span>
            <p class="text-blue-800 dark:text-blue-200 text-[11px]">
        ...
        <div class="pt-2 flex items-center justify-end">
          <button
            type="button"
            @click="showWhatsThisModal = false"
            class="px-4 py-2 bg-slate-900 dark:bg-slate-700 hover:bg-slate-800 dark:hover:bg-slate-600 text-white font-bold rounded-xl text-xs cursor-pointer"
          >
            Close
          </button>
        </div>
    ...
    >
      <div
        class="flex-1 flex flex-col max-w-6xl w-full mx-auto bg-slate-900 dark:bg-slate-700 border border-slate-800 rounded-3xl shadow-2xl overflow-hidden"
        @click.stop
      >
        ...
        <div class="px-6 py-4 border-b border-slate-800 bg-slate-900/90 flex flex-wrap items-center justify-between gap-3 shrink-0">
          ...
          <div class="flex flex-wrap items-center gap-2 text-xs font-bold">
            ...
            <div class="flex items-center bg-slate-800 rounded-xl p-1 border border-slate-700">
              ...
              <span class="px-2.5 font-mono text-[11px] text-blue-400 w-12 text-center">
        ...
        <div class="flex-1 bg-slate-950 overflow-auto flex items-center justify-center p-6 relative">
          ...
          <iframe
            v-else
            :src="previewModal.url"
            class="w-full h-[75vh] rounded-2xl bg-white dark:bg-slate-900 border border-slate-800 shadow-2xl transition-transform duration-150 ease-out origin-center"
    ...
    <div v-if="showEditInvoiceModal" class="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/75 backdrop-blur-sm p-4 overflow-y-auto" @click="showEditInvoiceModal = false">
      <div class="bg-white dark:bg-slate-900 rounded-3xl max-w-2xl w-full p-6 shadow-2xl border border-slate-200 dark:border-slate-800 space-y-5 my-8" @click.stop>
        <div class="flex items-center justify-between pb-3 border-b border-slate-100 dark:border-slate-800">
          <div>
            <h3 class="text-base font-black text-slate-900 dark:text-white">Edit Invoice {{ editingInvoice?.invoice_number }}</h3>
            <p class="text-xs text-slate-500 dark:text-slate-400">Update draft sales invoice details, customer, date or line items.</p>
          </div>
          <button type="button" @click="showEditInvoiceModal = false" class="text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 font-bold text-sm">✕</button>
        </div>

        <form @submit.prevent="submitEditInvoice" class="space-y-4 text-xs">
          <div class="grid grid-cols-2 gap-3">
            <div class="space-y-1">
              <label class="block font-bold text-slate-700 dark:text-slate-200">Customer *</label>
              <select
            ...
            <div class="space-y-1">
              <label class="block font-bold text-slate-700 dark:text-slate-200">Invoice Date *</label>
              <input
                v-model="editInvoiceForm.issue_date"
                type="date"
                class="w-full px-3 py-2 border border-slate-200 dark:border-slate-800 rounded-xl font-bold text-xs focus:outline-none focus:border-blue-500"
                required
              />
            </div>
          </div>
          ...
          <div class="grid grid-cols-2 gap-3">
            ...
            <div class="space-y-1">
              <label class="block font-bold text-slate-700 dark:text-slate-200">Reference / PO #</label>
              <input
          ...
          <div class="space-y-2 border-t border-slate-100 dark:border-slate-800 pt-3">
            <div class="flex items-center justify-between">
              <span class="font-extrabold text-slate-800 dark:text-slate-100">Line Items</span>
              <button
                type="button"
                @click="addEditInvoiceLine"
                class="px-2.5 py-1 text-[11px] font-bold bg-blue-50 dark:bg-blue-950/40 hover:bg-blue-100 dark:hover:bg-blue-900/40 text-blue-700 dark:text-blue-300 border border-blue-200 dark:border-blue-800/60 rounded-lg transition-all"
              >
                + Add Line
              </button>
            </div>

            <div v-for="(line, idx) in editInvoiceForm.lines" :key="idx" class="grid grid-cols-12 gap-2 items-center bg-slate-50 dark:bg-slate-800/50 p-2.5 rounded-xl border border-slate-200/80 dark:border-slate-800/80">
              <div class="col-span-5">
                <input
                  v-model="line.description"
                  type="text"
                  placeholder="Item Description..."
                  class="w-full px-2.5 py-1.5 border border-slate-200 dark:border-slate-800 rounded-lg text-xs font-medium focus:outline-none focus:border-blue-500 bg-white dark:bg-slate-900"
                  required
                />
              </div>
              <div class="col-span-3">
                <select
                  ...
                  class="w-full px-2 py-1.5 border border-slate-200 dark:border-slate-800 rounded-lg text-xs font-bold focus:outline-none focus:border-blue-500 bg-white dark:bg-slate-900"
                  required
                >
              ...
              <div class="col-span-3">
                <input
                  ...
                  step="0.01"
                  placeholder="0.00"
                  class="w-full px-2 py-1.5 border border-slate-200 dark:border-slate-800 rounded-lg text-xs font-mono font-bold focus:outline-none focus:border-blue-500 bg-white dark:bg-slate-900 text-right"
                  required
                />
              </div>
              <div class="col-span-1 text-center">
                <button
                  ...
                  class="text-rose-500 hover:text-rose-700 dark:hover:text-rose-300 font-bold text-xs"
                  title="Remove Line"
                >
                  ✕
                </button>
          ...
          <div class="flex items-center justify-end gap-3 border-t border-slate-100 dark:border-slate-800 pt-3">
            <button
              type="button"
              @click="showEditInvoiceModal = false"
              class="px-4 py-2 border border-slate-200 dark:border-slate-800 text-slate-600 dark:text-slate-300 rounded-xl font-bold hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors"
            >
              Cancel
            </button>
            <button
              ...
              class="px-5 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-extrabold shadow-sm transition-all disabled:opacity-50"
            >
    ...
    <div v-if="showEditBillModal" class="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/75 backdrop-blur-sm p-4 overflow-y-auto" @click="showEditBillModal = false">
      <div class="bg-white dark:bg-slate-900 rounded-3xl max-w-2xl w-full p-6 shadow-2xl border border-slate-200 dark:border-slate-800 space-y-5 my-8" @click.stop>
        <div class="flex items-center justify-between pb-3 border-b border-slate-100 dark:border-slate-800">
          <div>
            <h3 class="text-base font-black text-slate-900 dark:text-white">Edit Bill {{ editingBill?.bill_number }}</h3>
            <p class="text-xs text-slate-500 dark:text-slate-400">Update draft purchase bill details, supplier, date or expense line items.</p>
          </div>
          <button type="button" @click="showEditBillModal = false" class="text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 font-bold text-sm">✕</button>
        </div>

        <form @submit.prevent="submitEditBill" class="space-y-4 text-xs">
          <div class="grid grid-cols-2 gap-3">
            <div class="space-y-1">
              <label class="block font-bold text-slate-700 dark:text-slate-200">Supplier / Vendor *</label>
              <select
                v-model="editBillForm.contact_id"
                class="w-full px-3 py-2 border border-slate-200 dark:border-slate-800 rounded-xl text-xs font-bold focus:outline-none focus:border-amber-500"
                required
              >
            ...
            <div class="space-y-1">
              <label class="block font-bold text-slate-700 dark:text-slate-200">Bill Date *</label>
              <input
                v-model="editBillForm.issue_date"
                type="date"
                class="w-full px-3 py-2 border border-slate-200 dark:border-slate-800 rounded-xl font-bold text-xs focus:outline-none focus:border-amber-500"
                required
              />
            </div>
          </div>
          ...
          <div class="grid grid-cols-2 gap-3">
            ...
            <div class="space-y-1">
              <label class="block font-bold text-slate-700 dark:text-slate-200">Supplier Invoice / Ref #</label>
              <input
          ...
          <div class="space-y-2 border-t border-slate-100 dark:border-slate-800 pt-3">
            <div class="flex items-center justify-between">
              ...
              <button
                ...
                class="px-2.5 py-1 text-[11px] font-bold bg-amber-50 dark:bg-amber-950/40 hover:bg-amber-100 dark:hover:bg-amber-900/40 text-amber-800 dark:text-amber-200 border border-amber-200 dark:border-amber-800/60 rounded-lg transition-all"
              >
                + Add Line
              </button>
            </div>

            <div v-for="(line, idx) in editBillForm.lines" :key="idx" class="grid grid-cols-12 gap-2 items-center bg-slate-50 dark:bg-slate-800/50 p-2.5 rounded-xl border border-slate-200/80 dark:border-slate-800/80">
              <div class="col-span-5">
                <input
                  v-model="line.description"
                  type="text"
                  placeholder="Item Description..."
                  class="w-full px-2.5 py-1.5 border border-slate-200 dark:border-slate-800 rounded-lg text-xs font-medium focus:outline-none focus:border-amber-500 bg-white dark:bg-slate-900"
                  required
                />
              </div>
              <div class="col-span-3">
                <select
                  v-model="line.account_id"
                  class="w-full px-2 py-1.5 border border-slate-200 dark:border-slate-800 rounded-lg text-xs font-bold focus:outline-none focus:border-amber-500 bg-white dark:bg-slate-900"
                  required
                >
              ...
              <div class="col-span-3">
                <input
                  ...
                  step="0.01"
                  placeholder="0.00"
                  class="w-full px-2 py-1.5 border border-slate-200 dark:border-slate-800 rounded-lg text-xs font-mono font-bold focus:outline-none focus:border-amber-500 bg-white dark:bg-slate-900 text-right"
                  required
                />
              </div>
              <div class="col-span-1 text-center">
