        ...
        <div class="space-y-8 max-w-5xl mx-auto">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-200 pb-5">
                <div>
                    <div class="flex items-center gap-2 text-xs font-semibold text-slate-500 mb-1">
                        ...
                        <span>/</span>
                        <Link :href="route('superadmin.districts.show', district.id)" class="hover:text-slate-900 transition">{{ district.name }}</Link>
                        <span>/</span>
                        <span class="text-blue-600 font-bold">Edit</span>
                    </div>
                    <h1 class="text-2xl font-bold text-slate-900 tracking-tight">Edit {{ district.name }}</h1>
                    <p class="text-xs text-slate-500 mt-0.5">Update official details, executive leaders, contact information, and online presence.</p>
                </div>

                <Link
                    :href="route('superadmin.districts.show', district.id)"
                    class="px-4 py-2 bg-slate-100 hover:bg-slate-200 text-slate-800 text-xs font-bold rounded-xl border border-slate-300 transition flex-shrink-0"
                >
                    ← Cancel &amp; Back
                </Link>
            </div>
            ...
            <form @submit.prevent="submitUpdate" class="space-y-8">
                ...
                <div class="bg-white border border-slate-200 rounded-3xl p-6 shadow-xl space-y-4">
                    <h3 class="text-xs font-extrabold text-blue-600 uppercase tracking-wider border-b border-slate-200 pb-3 flex items-center gap-2">
                        <span>🌍</span>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
                        <div>
                            <label class="block font-bold text-slate-700 mb-1">Official Name</label>
                            <input
                                v-model="form.name"
                                type="text"
                                class="w-full bg-slate-100 border border-slate-300 text-slate-900 rounded-xl px-3.5 py-2.5 focus:ring-2 focus:ring-blue-500 font-bold"
                                required
                            />
                            <p v-if="form.errors.name" class="text-rose-700 mt-1">{{ form.errors.name }}</p>
                        </div>
                        ...
                        <div>
                            ...
                            <select
                                v-model="form.type"
                                class="w-full bg-slate-100 border border-slate-300 text-slate-900 rounded-xl px-3.5 py-2.5 focus:ring-2 focus:ring-blue-500 cursor-pointer font-medium"
                                required
                            >
                        ...
                        <div>
                            <label class="block font-bold text-slate-700 mb-1">Governing Grand Lodge</label>
                            <select
                        ...
                        <div>
                            <label class="block font-bold text-slate-700 mb-1">System Code Key</label>
                            <input
                                v-model="form.code"
                                type="text"
                                placeholder="e.g. singapore"
                                class="w-full bg-slate-100 border border-slate-300 text-slate-900 rounded-xl px-3.5 py-2.5 font-mono focus:ring-2 focus:ring-blue-500"
                                required
                            />
                            <p v-if="form.errors.code" class="text-rose-700 mt-1">{{ form.errors.code }}</p>
                        </div>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                type="text"
                                placeholder="e.g. Singapore"
                                class="w-full bg-slate-100 border border-slate-300 text-slate-900 rounded-xl px-3.5 py-2.5 focus:ring-2 focus:ring-blue-500 font-medium"
                            />
                        </div>

                        <div>
                            <label class="block font-bold text-slate-700 mb-1">Geographic Region</label>
                            <input
                                v-model="form.region"
                                type="text"
                ...
                <div class="bg-white border border-slate-200 rounded-3xl p-6 shadow-xl space-y-4">
                    <h3 class="text-xs font-extrabold text-amber-700 uppercase tracking-wider border-b border-slate-200 pb-3 flex items-center gap-2">
                        <span>👑</span>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
                        <div>
                            <label class="block font-bold text-slate-700 mb-1">District Grand Master</label>
                            <input
                        ...
                        <div>
                            <label class="block font-bold text-slate-700 mb-1">District Grand Secretary</label>
                            <input
                ...
                <div class="bg-white border border-slate-200 rounded-3xl p-6 shadow-xl space-y-4">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
                        ...
                        <div>
                            <label class="block font-bold text-slate-700 mb-1">Address Line 2 (Optional)</label>
                            <input
                        ...
                        <div>
                            <label class="block font-bold text-slate-700 mb-1">County / State / Province</label>
                            <input
                                v-model="form.county"
                                type="text"
                                class="w-full bg-slate-100 border border-slate-300 text-slate-900 rounded-xl px-3.5 py-2.5 focus:ring-2 focus:ring-blue-500 font-medium"
                        ...
                        <div>
                            ...
                            <input
                                ...
                                class="w-full bg-slate-100 border border-slate-300 text-slate-900 rounded-xl px-3.5 py-2.5 font-mono focus:ring-2 focus:ring-blue-500 font-medium"
                            />
                        </div>

                        <div>
                            <label class="block font-bold text-slate-700 mb-1">Telephone Number</label>
                            <input
                ...
                <div class="bg-white border border-slate-200 rounded-3xl p-6 shadow-xl space-y-4">
                    <h3 class="text-xs font-extrabold text-sky-700 uppercase tracking-wider border-b border-slate-200 pb-3 flex items-center gap-2">
                        <span>🌐</span>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
                        <div>
                            <label class="block font-bold text-slate-700 mb-1">Twitter / X URL</label>
                            <input
                ...
                <div class="bg-white border border-slate-200 rounded-3xl p-6 shadow-xl space-y-4">
                    <h3 class="text-xs font-extrabold text-emerald-700 uppercase tracking-wider border-b border-slate-200 pb-3 flex items-center gap-2">
                        <span>📖</span>
                        <span>Overview, Background &amp; Notes</span>
                    </h3>

                    <div class="text-xs">
                        <label class="block font-bold text-slate-700 mb-1">Description &amp; Historical Notes</label>
                        <textarea
                            v-model="form.description"
                            rows="4"
                            placeholder="Enter historical background, status notes (e.g. dormant reason), number of lodges, charity activities, etc."
                            class="w-full bg-slate-100 border border-slate-300 text-slate-900 rounded-2xl px-4 py-3 focus:ring-2 focus:ring-blue-500 font-medium leading-relaxed"
                        ></textarea>
                    </div>
                </div>
                ...
                <div class="flex items-center justify-end gap-3 pt-4 border-t border-slate-200">
                    <Link
                        :href="route('superadmin.districts.show', district.id)"
                        class="px-5 py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-700 font-bold text-xs rounded-xl border border-slate-300 transition"
                    >
                        Cancel
                    </Link>
                    <button
