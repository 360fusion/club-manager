        ...
        <div class="space-y-6">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-200 pb-5">
                <div>
                    <div class="flex items-center gap-2 text-xs font-semibold text-slate-500 mb-1">
                        ...
                        <span>/</span>
                        <span class="text-emerald-700 font-bold">Australian Grand Lodges</span>
                    </div>
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                <div class="bg-white border border-slate-200 p-4 rounded-xl shadow-lg space-y-1">
                    <span class="text-[10px] font-bold text-emerald-700 uppercase tracking-wider block">State Grand Lodges</span>
                    <span class="text-2xl font-black text-slate-900 block">6</span>
                    <span class="text-[11px] text-slate-500 block font-medium">Fully sovereign bodies</span>
                </div>
                <div class="bg-white border border-slate-200 p-4 rounded-xl shadow-lg space-y-1">
                    <span class="text-[10px] font-bold text-blue-600 uppercase tracking-wider block">In Database</span>
                    <span class="text-2xl font-black text-slate-900 block">{{ australianGrandLodges.length }}</span>
                    <span class="text-[11px] text-slate-500 block font-medium">of 6 seeded</span>
                </div>
                <div class="bg-white border border-slate-200 p-4 rounded-xl shadow-lg space-y-1">
                    ...
                    <span class="text-[11px] text-slate-500 block font-medium">Across all Australian states</span>
                </div>
                <div class="bg-white border border-slate-200 p-4 rounded-xl shadow-lg space-y-1">
                    <span class="text-[10px] font-bold text-blue-600 uppercase tracking-wider block">Coordination Body</span>
                    <span class="text-sm font-black text-slate-900 block leading-tight">Australasian Masonic Forum</span>
                    <span class="text-[11px] text-slate-500 block font-medium">Advisory only, no authority</span>
                </div>
            </div>

            <!-- Search Bar -->
            <div class="bg-white border border-slate-200 p-4 rounded-xl shadow-lg">
                <div class="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-4">
                    ...
                    <div class="text-xs text-slate-500 font-medium">
                        Showing <strong class="text-slate-900">{{ filteredLodges.length }}</strong> of 6 Grand Lodges
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white border border-slate-200 rounded-xl overflow-hidden shadow-xl">
                <div class="p-4 border-b border-slate-200 flex items-center justify-between">
                    ...
                    <span v-if="australianGrandLodges.length < 6" class="text-[10px] text-amber-700 font-semibold">
                    ...
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="divide-y divide-slate-200 text-xs">
                            <tr v-for="gl in filteredLodges" :key="gl.code" class="hover:bg-slate-50 transition group">
                                ...
                                <!-- Website -->
                                <td class="py-3.5 px-3">
                                    <a :href="gl.website" target="_blank" rel="noopener" class="text-blue-600 hover:underline flex items-center gap-1 whitespace-nowrap">
                                        <span>Website</span>
            ...
            <div class="bg-amber-50 border border-amber-200 rounded-2xl p-4 flex items-start gap-3">
                ...
                <p class="text-xs text-amber-800 leading-relaxed">
                    ...
                    All six are in amity with UGLE and coordinate via the <span class="font-semibold text-slate-900">Australasian Masonic Forum</span> (advisory only).
                </p>
            </div>
