      ...
      <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-200 pb-5">
        <div>
          <div class="flex items-center gap-2 text-xs font-semibold text-slate-500 mb-1">
            ...
            <span>/</span>
            <Link :href="route('superadmin.provinces.index')" class="hover:text-slate-900 transition">Provinces</Link>
            <span>/</span>
            <Link :href="route('superadmin.provinces.show', province.id)" class="hover:text-slate-900 transition">{{ province.name }}</Link>
            <span>/</span>
            <span class="text-blue-600 font-bold">Edit</span>
          </div>
          <h1 class="text-2xl font-bold text-slate-900 tracking-tight">Edit {{ province.name }}</h1>
          <p class="text-xs text-slate-500 mt-0.5">Update official office address, executive leaders, contact details, and web portals.</p>
        </div>

        <Link
          :href="route('superadmin.provinces.show', province.id)"
          class="px-4 py-2 bg-slate-100 hover:bg-slate-200 text-slate-800 text-xs font-bold rounded-xl border border-slate-300 transition"
        >
      ...
      <form @submit.prevent="submitUpdate" class="space-y-8">
        ...
        <div class="bg-white border border-slate-200 rounded-3xl p-6 shadow-xl space-y-4">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
            <div>
              <label class="block font-bold text-slate-700 mb-1">Province Official Name</label>
              <input
                v-model="form.name"
                type="text"
            ...
            <div>
              <label class="block font-bold text-slate-700 mb-1">Governing Sovereign Grand Lodge</label>
              <select
            ...
            <div>
              <label class="block font-bold text-slate-700 mb-1">Country Jurisdiction</label>
              <select
        ...
        <div class="bg-white border border-slate-200 rounded-3xl p-6 shadow-xl space-y-4">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
            ...
            <div>
              <label class="block font-bold text-slate-700 mb-1">Provincial Grand Secretary</label>
              <input
        ...
        <div class="bg-white border border-slate-200 rounded-3xl p-6 shadow-xl space-y-4">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
            ...
            <div>
              <label class="block font-bold text-slate-700 mb-1">County</label>
              <input
                v-model="form.county"
                type="text"
        ...
        <div class="bg-white border border-slate-200 rounded-3xl p-6 shadow-xl space-y-4">
          ...
          <div class="text-xs">
            <label class="block font-bold text-slate-700 mb-1">Province Description &amp; History</label>
            <textarea
