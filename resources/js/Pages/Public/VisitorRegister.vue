...
<template>
  ...
  <div class="min-h-screen bg-slate-900 text-slate-100 flex flex-col justify-center py-12 sm:px-6 lg:px-8 selection:bg-blue-500 selection:text-white">
    <div class="sm:mx-auto sm:w-full sm:max-w-md text-center">
      <div class="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-blue-600/20 text-blue-400 border border-blue-500/30 mb-4 shadow-xl">
      ...
      <p class="mt-2 text-sm text-slate-400 font-medium">
        Register as a Visitor for <span class="text-blue-400 font-semibold">{{ club.name }}</span> to receive meeting summonses and RSVP invites.
      </p>
    </div>
        ...
        <form @submit.prevent="submit" class="space-y-5">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div>
              ...
              <input 
                ...
                class="w-full bg-slate-900/80 border border-slate-700 rounded-xl px-3.5 py-2.5 text-sm text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
            </div>
          ...
          <div>
            ...
            <textarea 
              ...
              class="w-full bg-slate-900/80 border border-slate-700 rounded-xl px-3.5 py-2.5 text-sm text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none"
            ></textarea>
          </div>
          ...
          <div class="pt-2">
            <button 
              ...
              class="w-full py-3 px-4 bg-blue-600 hover:bg-blue-500 text-white font-bold rounded-xl shadow-lg shadow-blue-600/30 transition-all flex items-center justify-center gap-2 cursor-pointer"
            >
