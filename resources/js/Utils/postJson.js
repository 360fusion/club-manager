...
export async function postJson(url, body, networkMessage = 'Could not work out the price. Check your connection.') {
    ...
    try {
        ...
        return { ok: false, status: 0, data: { message: networkMessage } };
    }
}
