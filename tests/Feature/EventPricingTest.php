...
class EventPricingTest extends TestCase
{
    ...
    {
        $method = ClubPaymentMethod::create(['club_id' => $this->club->id, 'type' => $type, 'label' => $label, 'sort_order' => ClubPaymentMethod::count()] + ($type === 'card_online' ? ['config' => ['stripe_secret_key' => 'sk_test_x', 'stripe_webhook_secret' => 'whsec_x']] : ($type === 'bank_transfer' ? ['config' => ['account_number' => '12345678']] : [])) + array_filter([
