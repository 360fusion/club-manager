...
return new class extends Migration
{
    ...
    {
        if (! Schema::hasTable('club_acc_subscription_tiers')) {
        ...
        if (! Schema::hasTable('club_acc_member_subscriptions')) {
        ...
        if (Schema::hasTable('club_acc_members') && ! Schema::hasColumn('club_acc_members', 'subscription_tier_id')) {
