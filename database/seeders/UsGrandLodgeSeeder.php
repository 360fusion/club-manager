...
class UsGrandLodgeSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $grandLodges = [
            ...
            // South Atlantic
            ['name' => 'Grand Lodge of Florida F&AM', 'code' => 'usglfl', 'short_name' => 'GL Florida', 'website_url' => 'https://glflamason.org', 'description' => 'Sovereign Grand Lodge for the State of Florida. Chartered 1830; headquartered in Jacksonville.'],
            ...
            ['name' => 'Grand Lodge of North Carolina AF&AM', 'code' => 'usglnc', 'short_name' => 'GL North Carolina', 'website_url' => 'https://grandlodge-nc.org', 'description' => 'Sovereign Grand Lodge for the State of North Carolina. Chartered 1787; headquartered in Raleigh.'],
            ...
            ['name' => 'Grand Lodge of Arkansas F&AM', 'code' => 'usglar', 'short_name' => 'GL Arkansas', 'website_url' => 'https://arkansasmason.org', 'description' => 'Sovereign Grand Lodge for the State of Arkansas. Chartered 1838; headquartered in Little Rock.'],
            ['name' => 'Grand Lodge of Kentucky F&AM', 'code' => 'usglky', 'short_name' => 'GL Kentucky', 'website_url' => 'https://grandlodgeofkentucky.org', 'description' => 'Sovereign Grand Lodge for the Commonwealth of Kentucky. Chartered 1800; headquartered in Louisville.'],
            ...
            ['name' => 'Grand Lodge of Oklahoma AF&AM', 'code' => 'usglok', 'short_name' => 'GL Oklahoma', 'website_url' => 'https://gloklahoma.org', 'description' => 'Sovereign Grand Lodge for the State of Oklahoma. Formed 1909 by the union of the Indian Territory and Oklahoma Territory Grand Lodges; headquartered in Guthrie.'],
            ...
            ['name' => 'Grand Lodge of Wisconsin F&AM', 'code' => 'usglwi', 'short_name' => 'GL Wisconsin', 'website_url' => 'https://wisc-freemasonry.org', 'description' => 'Sovereign Grand Lodge for the State of Wisconsin. Chartered 1843; headquartered in Dousman.'],
            ...
            ['name' => 'Grand Lodge of Minnesota AF&AM', 'code' => 'usglmn', 'short_name' => 'GL Minnesota', 'website_url' => 'https://mn-masons.org', 'description' => 'Sovereign Grand Lodge for the State of Minnesota. Chartered 1853; headquartered in Bloomington.'],
            ...
            ['name' => 'Grand Lodge of North Dakota AF&AM', 'code' => 'usglnd', 'short_name' => 'GL North Dakota', 'website_url' => 'https://ndmasons.org', 'description' => 'Sovereign Grand Lodge for the State of North Dakota. Chartered 1889, the year of statehood; headquartered in Fargo.'],
            ['name' => 'Grand Lodge of South Dakota AF&AM', 'code' => 'usglsd', 'short_name' => 'GL South Dakota', 'website_url' => 'https://grandlodgeofsouthdakota.org', 'description' => 'Sovereign Grand Lodge for the State of South Dakota. Traces to the 1875 Dakota Territory Grand Lodge; headquartered in Sioux Falls.'],
            ...
            ['name' => 'Grand Lodge of Idaho AF&AM', 'code' => 'usglid', 'short_name' => 'GL Idaho', 'website_url' => 'https://idahoaf-am.org', 'description' => 'Sovereign Grand Lodge for the State of Idaho. Chartered 1867; headquartered in Boise.'],
            ...
            ['name' => 'Grand Lodge of Alaska F&AM', 'code' => 'usglak', 'short_name' => 'GL Alaska', 'website_url' => 'https://alaska-mason.org', 'description' => 'Sovereign Grand Lodge for the State of Alaska. Chartered 1981, the second-youngest US jurisdiction; headquartered in Anchorage.'],
            ...
            ['name' => 'Grand Lodge of Hawaii F&AM', 'code' => 'usglhi', 'short_name' => 'GL Hawaii', 'website_url' => 'https://hawaiifreemasons.org', 'description' => 'Sovereign Grand Lodge for the State of Hawaii. Chartered 1989, the youngest US jurisdiction; headquartered in Honolulu.'],
            ['name' => 'Grand Lodge of Oregon AF&AM', 'code' => 'usglor', 'short_name' => 'GL Oregon', 'website_url' => 'https://masonic-oregon.com', 'description' => 'Sovereign Grand Lodge for the State of Oregon. Chartered 1851; headquartered in Forest Grove.'],
